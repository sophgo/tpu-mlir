...
setup(
    ...
    author="TPU-MLIR Team",
    author_email="",
    description=f"Machine learning compiler based on MLIR for TPU {os.getenv('mlir_version').split('-')[0]}-g{os.getenv('mlir_commit_id')}-{os.getenv('mlir_commit_date')}",
