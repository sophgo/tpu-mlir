...
void py_cuda::cudaLSTMOp(top::LSTMOp op) {
  ...
  for (int d = 0; d < num_dir; d++) {
    ...
    for (int t = 0; t < seq_len; t++) {
      ...
      cuda::mmF32(x_t, W_i, x_i, batch_size, input_size, hidden_size, false, true);
      cuda::mmF32(x_t, W_o, x_o, batch_size, input_size, hidden_size, false, true);
      cuda::mmF32(x_t, W_f, x_f, batch_size, input_size, hidden_size, false, true);
      cuda::mmF32(x_t, W_c, x_c, batch_size, input_size, hidden_size, false, true);

      // hidden matmuls: h_i = hidden * R_i^T  (4 gates)
      cuda::mmF32(hidden_buf, R_i, h_i, batch_size, hidden_size, hidden_size, false, true);
      cuda::mmF32(hidden_buf, R_o, h_o, batch_size, hidden_size, hidden_size, false, true);
      cuda::mmF32(hidden_buf, R_f, h_f, batch_size, hidden_size, hidden_size, false, true);
      cuda::mmF32(hidden_buf, R_c, h_c, batch_size, hidden_size, hidden_size, false, true);
