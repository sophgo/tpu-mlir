...
class CDMAProfileFormat(dictStructure):
    ...
    _fields_ = [
        ...
        ("inst_start_time", ct.c_uint32),
        ("inst_end_time", ct.c_uint32),
        ("inst_id", ct.c_uint32, 24),
        ("thread_id", ct.c_uint32, 1),
        ("reserved0", ct.c_uint32, 7),
        ("_reserved0", ct.c_uint32),
        # H1
        ("m0_data_aw_cntr", ct.c_uint32),
        ("m0_data_wr_cntr", ct.c_uint32),
        ("m0_data_ar_cntr", ct.c_uint32),
        ("reserved1", ct.c_uint32),
        # H2
        ("m0_data_wr_valid_cntr", ct.c_uint32),
        ("m0_data_wr_stall_cntr", ct.c_uint32),
        ("m0_data_rd_valid_cntr", ct.c_uint32),
        ("m0_data_rd_stall_cntr", ct.c_uint32),
        # H3
        ("ati_data_valid_cntr", ct.c_uint32),
        ("ati_data_stall_cntr", ct.c_uint32),
        ("ari_data_valid_cntr", ct.c_uint32),
        ("ari_data_stall_cntr", ct.c_uint32),
        # H4
        ("ati_txfifo_stall_cntr", ct.c_uint32),
        ("replay_number", ct.c_uint32),
        ("m0_data_b_st", ct.c_uint32),
        ("m0_data_b_end", ct.c_uint32),
        # H5
        ("m0_data_ar_st", ct.c_uint32),
        ("m0_data_ar_end", ct.c_uint32),
        ("m0_data_aw_st", ct.c_uint32),
        ("m0_data_aw_end", ct.c_uint32),
        # H6
        ("m0_data_rd_st", ct.c_uint32),
        ("m0_data_rd_end", ct.c_uint32),
        ("m0_data_wr_st", ct.c_uint32),
        ("m0_data_wr_end", ct.c_uint32),
        # H7
        ("ati_data_st", ct.c_uint32),
        ("ati_data_end", ct.c_uint32),
        ("ari_data_st", ct.c_uint32),
        ("ari_data_end", ct.c_uint32),
    ]
...
class GDMACmdFormat(dictStructure):
    ...
    _fields_ = [
        # 32 bit align
        ("intr_en", ct.c_uint32, 1),
        ("stride_enable", ct.c_uint32, 1),
        ("nchw_copy", ct.c_uint32, 1),
        ("cmd_short", ct.c_uint32, 1),
        ("cache_en", ct.c_uint32, 1),
        ("cache_flush", ct.c_uint32, 1),
        # 32bit
        ("reserved0", ct.c_uint32, 26),
        ("cmd_type", ct.c_uint32, 5),
        ("cmd_special_function", ct.c_uint32, 3),
        ("fill_constant_en", ct.c_uint32, 1),
        ("src_data_format", ct.c_uint32, 4),
        ("reserved1", ct.c_uint32, 3),
        # 64 bit
        ("reserved2", ct.c_uint32, 16),
        ("cmd_id_dep", ct.c_uint32, 17),
        ("reserved3", ct.c_uint32, 6),
        ("break_point", ct.c_uint32, 1),
        # 128 bit
        ("reserved4", ct.c_uint32, 8),
        ("constant_value", ct.c_uint32),
        ("src_nstride", ct.c_uint32),
        ("src_cstride", ct.c_uint32),
        ("src_hstride", ct.c_uint32),
        ("src_wstride", ct.c_uint32),
        ("dst_nstride", ct.c_uint32),
        ("dst_cstride", ct.c_uint32),
        ("dst_hstride", ct.c_uint32),
        ("dst_wstride", ct.c_uint32),
        ("src_nsize", ct.c_uint32, 16),
        ("src_csize", ct.c_uint32, 16),
        ("src_hsize", ct.c_uint32, 16),
        ("src_wsize", ct.c_uint32, 16),
        ("dst_nsize", ct.c_uint32, 16),
        ("dst_csize", ct.c_uint32, 16),
        ("dst_hsize", ct.c_uint32, 16),
        ("dst_wsize", ct.c_uint32, 16),
        ("src_start_addr_l32", ct.c_uint32),
        ("src_start_addr_h13", ct.c_uint32, 13),
        ("reserved5", ct.c_uint32, 19),
        ("dst_start_addr_l32", ct.c_uint32),
        ("dst_start_addr_h13", ct.c_uint32, 13),
        ("reserved6", ct.c_uint32, 19),
        ("all_reduce_code", ct.c_uint32, 16),
        ("reserved7", ct.c_uint32, 16),
        ("reserved8", ct.c_uint32, 16),
        ("reserved9", ct.c_uint32, 16),
        ("localmem_mask_l32", ct.c_uint32),
        ("localmem_mask_h32", ct.c_uint32),
    ]
...
class ProfileFormat(dictStructure):
    ...
    '''
    _pack_ = 1
    _fields_ = [("type", ct.c_uint32, 8), ("engine", ct.c_uint32, 3),
...
def get_dma_info_dyn(monitor_info, reg_info, engine_id=1):
    ...
    dma_info["Function Type"], dma_info["Function Name"] = parser(reg_info.des_tsk_typ,
                                                                  reg_info.des_tsk_eu_typ,
                                                                  dma_info["Direction"])
    ...
    if engine_id != 4:
        ...
        dma_info["gmem_bandwidth"] = round(dma_info["gmem_xfer_bytes(B)"] / dma_info["Asic Cycle"],
                                           4)
        ...
        dma_info["DDR Bandwidth(GB/s)"] = max(dma_info["lmem_bandwidth"],
                                              dma_info["gmem_bandwidth"])
        ...
        dma_info[
            "DMA data size(B)"] = monitor_info.m0_data_aw_cntr  # + monitor_info.m0_data_ar_cntr
        dma_info["DDR Bandwidth(GB/s)"] = round(
            dma_info["DMA data size(B)"] / dma_info["Asic Cycle"], 4)
...
def get_dma_info(monitor_info, reg_info, core_id, engine_id=1):
    ...
    dma_info["from_addr"] = src_type
    dma_info["to_addr"] = dst_type
    dma_info["Function Type"], dma_info["Function Name"] = parser(reg_info.cmd_type,
                                                                  reg_info.cmd_special_function,
                                                                  dma_info["Direction"])
    dma_info["Start Cycle"] = monitor_info.inst_start_time
    dma_info["End Cycle"] = monitor_info.inst_end_time
    dma_info["Cmd Id"] = monitor_info.inst_id
    ...
    if "DDR" in dma_info["Direction"]:
        ...
        dma_info['L2M Bandwidth(GB/s)'] = max(dma_info["lmem_bandwidth"],
                                              dma_info["gmem_bandwidth"])
    else:
        dma_info["DDR Bandwidth(GB/s)"] = 0
        dma_info['L2M Bandwidth(GB/s)'] = 0
...
def getTiuFunctionName(cmd_type, cmd_special_function):
    tiuFunctionNameDict = {
        ...
        (6, 7): 'PE_M_gather_d1coor [N]',
        (6, 8): 'PE_S_mask_select',
        (6, 9): 'PE_S_nonzero',
        (6, 10): 'PE_S_scatter_pp_d1coor [N]',
        ...
        (7, 4): 'linear_max',
        (7, 5): 'linear_min',
        (7, 6): 'linear_logic_shift',
        (7, 7): 'linear_and',
        (7, 8): 'linear_or',
        (7, 9): 'linear_xor',
        (7, 10): 'linear_select_great',
        (7, 11): 'linear_select_equal',
        (7, 12): 'linear_div',
        (7, 13): 'linear_select_less',
        (7, 14): 'linear_data_convert',
        (7, 15): 'linear_add_satu',
        (7, 16): 'linear_sub_satu',
        (7, 17): 'linear_clamp',
        (7, 18): 'linear_mac',
        (7, 19): 'linear_copy',
        (7, 20): 'linear_mul_satu',
        # rand_gen
        8: "rand_gen",
        (8, 0): 'prng ',
        (8, 1): 'prng with intial seed',
        (8, 2): ':prng with loaded states',
        # special_function
        9: 'md/sfu',
        (9, 12): 'tailor_4x',
        (9, 13): 'tailor',
        ...
        # fused_cmpare
        13: 'fused_cmpare',
        (13, 22): 'CMP_gt and CMP_sel_gt',
        (13, 23): 'CMP_sel_gt',
        (13, 24): 'CMP_sel_eq',
        (13, 25): 'CMP_lt and CMP_sel_lt',
        (13, 26): 'CMP_sel_lt',
        (13, 27): 'CMP_srch_bin',
        # vector correlation
    ...
    functinName = tiuFunctionNameDict.get((cmd_type, cmd_special_function),
                                          f"{functionType}_{cmd_special_function}")
...
def getDmaFunctionName(cmd_type, cmd_special_function, direction):
    dmaFunctionNameDict = {
        ...
        (4, 1): 'DMA_cw transpose',
        (4, 5): 'DMA_cw transpose',
        (5, 0): 'DMA_nonzero',
        (6, 0): 'DMA_sys',
        (6, 1): 'nop',
        (6, 2): 'sys_tr_wr',
...
def getCdmaFunctionName(cmd_type, cmd_special_function, no_use):
    ...
    functinName = cdmaFunctionNameDict.get((cmd_type, cmd_special_function),
                                           f"{functionType}_{cmd_special_function}")
    return functionType, functinName
