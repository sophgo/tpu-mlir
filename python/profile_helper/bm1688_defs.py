...
class GDMAProfileFormat(dictStructure):
    ...
    _fields_ = [
        ...
        ("fmem_aw_bytes", ct.c_uint32),
        ("fmem_wr_bytes", ct.c_uint32),
        ("fmem_ar_bytes", ct.c_uint32),
        ("l2sram_aw_bytes", ct.c_uint32),
        ("l2sram_wr_bytes", ct.c_uint32),
        ("l2sram_ar_bytes", ct.c_uint32),
        ("reserved1", ct.c_uint32),
        ("d0_wr_valid_bytes", ct.c_uint32),
        ("d0_rd_valid_bytes", ct.c_uint32),
        ("d1_wr_valid_bytes", ct.c_uint32),
        ("d1_rd_valid_bytes", ct.c_uint32),
        ("fmem_wr_valid_bytes", ct.c_uint32),
        ("fmem_rd_valid_bytes", ct.c_uint32),
        ("l2sram_wr_valid_bytes", ct.c_uint32),
        ("l2sram_rd_valid_bytes", ct.c_uint32),
        # ("no_need40", ct.c_uint64), ("no_need48", ct.c_uint64),
        # ("no_need50", ct.c_uint64), ("no_need58", ct.c_uint64),
        ("no_need60", ct.c_uint64),
        ("no_need68", ct.c_uint64),
        ...
        ("no_need80", ct.c_uint64),
        ("no_need88", ct.c_uint64),
        ("no_need90", ct.c_uint64),
        ("no_need98", ct.c_uint64),
        ("no_needA0", ct.c_uint64),
        ("no_needA8", ct.c_uint64),
        ("no_needB0", ct.c_uint64),
        ("no_needB8", ct.c_uint64),
        ("no_needC0", ct.c_uint64),
        ("no_needC8", ct.c_uint64),
        ("no_needD0", ct.c_uint64),
        ("no_needD8", ct.c_uint64),
        ("no_needE0", ct.c_uint64),
        ("no_needE8", ct.c_uint64),
        ("no_needF0", ct.c_uint64),
        ("no_needF8", ct.c_uint64),
    ]
...
def get_dma_info(monitor_info, reg_info):
    ...
    if is_sys:
        ...
        dma_info["dst_start_addr"] = (int(dma_info["dst_start_addr_h8"]) << 32) + int(
            dma_info["dst_start_addr_l32"])
        dma_info["src_start_addr"] = (int(dma_info["src_start_addr_h8"]) << 32) + int(
    ...
    dma_info["gmem_bandwidth"] = round(
        dma_info["gmem_xfer_bytes(B)"] / dma_info["Asic Cycle"] * 0.75, 4)
    ...
    dma_info["gmem_xact_cnt"] = (monitor_info.d0_ar_bytes + monitor_info.d0_aw_bytes +
                                 monitor_info.d1_ar_bytes +
                                 monitor_info.d1_aw_bytes) // DMA_ARCH["Vector OHOW Align(8bits)"]
    dma_info["lmem_xfer_bytes"] = monitor_info.fmem_aw_bytes + \
        monitor_info.fmem_ar_bytes
    dma_info["lmem_bandwidth"] = round(dma_info["lmem_xfer_bytes"] / dma_info["Asic Cycle"] * 0.75,
                                       4)
    dma_info["lmem_dma_data_size(B)"] = dma_info["lmem_xfer_bytes"]
    dma_info["lmem_xact_cnt"] = (monitor_info.fmem_ar_bytes +
                                 monitor_info.fmem_aw_bytes) // DMA_ARCH["Vector OHOW Align(8bits)"]
