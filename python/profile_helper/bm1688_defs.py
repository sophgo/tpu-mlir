...
class GDMAProfileFormat(dictStructure):
    _pack_ = 1
    _fields_ = [
        ("inst_start_time", ct.c_uint32), ("inst_end_time", ct.c_uint32), ("inst_id", ct.c_uint32, 20), ("reserved", ct.c_uint32, 12), ("d0_aw_bytes", ct.c_uint32),
        ("d0_wr_bytes", ct.c_uint32), ("d0_ar_bytes", ct.c_uint32), ("d1_aw_bytes", ct.c_uint32), ("d1_wr_bytes", ct.c_uint32),
        ("d1_ar_bytes", ct.c_uint32), ("fmem_aw_bytes", ct.c_uint32), ("fmem_wr_bytes", ct.c_uint32), ("fmem_ar_bytes", ct.c_uint32),
				("l2sram_aw_bytes", ct.c_uint32), ("l2sram_wr_bytes", ct.c_uint32), ("l2sram_ar_bytes", ct.c_uint32), ("reserved1", ct.c_uint32),
				("d0_wr_valid_bytes", ct.c_uint32), ("d0_rd_valid_bytes", ct.c_uint32), ("d1_wr_valid_bytes", ct.c_uint32), ("d1_rd_valid_bytes", ct.c_uint32),
        ("fmem_wr_valid_bytes", ct.c_uint32), ("fmem_rd_valid_bytes", ct.c_uint32), ("l2sram_wr_valid_bytes", ct.c_uint32), ("l2sram_rd_valid_bytes", ct.c_uint32),
...
def get_dma_info(monitor_info, reg_info):
  ...
  dma_info["Function Type"], dma_info["Function Name"] = getDmaFunctionName(reg_info.cmd_type, reg_info.cmd_special_function, dma_info["Direction"])
  ...
  dma_info["Bandwidth"] = max(dma_info["lmem_bandwidth"], dma_info["gmem_bandwidth"])
