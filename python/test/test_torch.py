...
class TORCH_IR_TESTER(object):
    ...
    def __init__(self,
        ...
        self.test_cases = {
            ...
            ##################################
            # case: (test, bm1684x_support, bm1688_support, cv183x_support, cv184x_support)
            "Abs":              (self.test_Abs,               Y, Y, Y, Y),
            "Activation":       (self.test_Activation,        Y, Y, Y, N),
            "AdaptiveAvgPool1d":(self.test_AdaptiveAvgPool1d, Y, N, N, Y),
            "AdaptiveAvgPool2d":(self.test_AdaptiveAvgPool2d, Y, Y, Y, N),
            "Add":              (self.test_Add,               Y, Y, Y, Y),
            "AddLarge":         (self.test_AddLarge,          Y, Y, N, Y),
            "Add5d":            (self.test_Add5d,             Y, Y, Y, Y),
            "Add6d":            (self.test_Add6d,             Y, Y, Y, Y),
            "Addmm":            (self.test_Addmm,             Y, Y, Y, Y),
            "Arange":           (self.test_Arange,            Y, Y, Y, Y),
            "Arctan":           (self.test_Arctan,            Y, Y, N, Y),
            "Arctanh":          (self.test_Arctanh,           Y, Y, N, Y),
            "Arccos":           (self.test_Arccos,            Y, Y, N, Y),
            "Arg":              (self.test_Arg,               Y, Y, N, Y),
            "Attention":        (self.test_Attention,         Y, Y, Y, Y),
            "AttentionNew":     (self.test_AttentionNew,      Y, N, N, N),
            "AvgPool1d":        (self.test_AvgPool1d,         Y, Y, Y, Y),
            "AvgPool2d":        (self.test_AvgPool2d,         Y, Y, Y, Y),
            "AvgPool3d":        (self.test_AvgPool3d,         Y, Y, Y, N),
            "BatchNorm":        (self.test_BatchNorm,         Y, Y, Y, Y),
            "BMM":              (self.test_BatchMatMul,       Y, Y, Y, Y),
            "Ceil":             (self.test_Ceil,              Y, N, N, Y),
            "ChannelShuffle":   (self.test_ChannelShuffle,    Y, Y, Y, Y),
            "Chunk":            (self.test_Chunk,             Y, Y, Y, Y),
            "Clamp":            (self.test_Clamp,             Y, Y, Y, Y),
            "Compare":          (self.test_Compare,           Y, Y, N, Y),
            "Concat":           (self.test_Concat,            Y, Y, Y, Y),
            "ConstantLike":     (self.test_ConstantLike,      Y, Y, Y, Y),
            "Conv1d":           (self.test_Conv1d,            Y, Y, Y, Y),
            "Conv2d":           (self.test_Conv2d,            Y, Y, Y, Y),
            "Conv3d":           (self.test_Conv3d,            Y, Y, N, Y),
            "ConvMerge":        (self.test_ConvMerge,         Y, Y, Y, Y),
            "ConvGroup":        (self.test_ConvGroup,         Y, Y, Y, Y),
            "ConvTrans":        (self.test_ConvTrans,         Y, Y, Y, N),
            "ConstantFill":     (self.test_ConstantFill,      Y, Y, Y, Y),
            "DeformConv2D":     (self.test_DeformConv2D,      Y, N, N, N),
            "Div":              (self.test_Div,               Y, Y, Y, Y),
            "Dot":              (self.test_Dot,               Y, N, N, Y),
            "Dropout":          (self.test_Dropout,           Y, Y, Y, Y),
            "Elu":              (self.test_Elu,               Y, Y, Y, Y),
            "Embedding":        (self.test_Embedding,         Y, Y, Y, Y),
            "FAttention":       (self.test_FAttention,        Y, N, N, Y),
            "Flatten":          (self.test_Flatten,           Y, Y, N, Y),
            "Flip":             (self.test_Flip,              Y, Y, N, Y),
            "Floor":            (self.test_Floor,             Y, Y, N, Y),
            "FloorDiv":         (self.test_FloorDiv,          Y, Y, N, Y),
            "FrobeniusNorm":    (self.test_FrobeniusNorm,     Y, Y, N, Y),
            "Gather":           (self.test_Gather,            N, N, N, N),
            "GridSampler":      (self.test_GridSampler,       Y, N, Y, N),
            ...
            "SplitGridSampler":(self.test_SplitGridSampler,   Y, Y, N, N),
            "GridSampleInDeformableAttn":(self.test_GridSampleInDeformableAttn, Y, Y, N, N),
            "GroupNorm":        (self.test_GroupNorm,         Y, Y, N, Y),
            "GRU":              (self.test_GRU,               Y, Y, Y, N),
            "IndexPut":         (self.test_IndexPut,          Y, Y, N, Y),
            "IndexSelect":      (self.test_IndexSelect,       Y, Y, Y, Y),
            "InstanceNorm":     (self.test_InstanceNorm,      Y, Y, Y, Y),
            "Interp":           (self.test_Interp,            Y, Y, Y, Y),
            "Interp2":           (self.test_Interp2,          Y, Y, N, Y),
            "LayerNorm":        (self.test_LayerNorm,         Y, Y, Y, Y),
            "LeakyRelu":        (self.test_LeakyRelu,         Y, Y, Y, Y),
            "Linear":           (self.test_Linear,            Y, Y, Y, Y),
            "LogSoftmax":       (self.test_LogSoftmax,        Y, Y, Y, Y),
            "LSTM":             (self.test_LSTM,              Y, Y, Y, N),
            "MaskedFill":       (self.test_MaskedFill,        Y, Y, N, Y),
            "Math":             (self.test_Math,              Y, Y, N, Y),
            "MatMul":           (self.test_MatMul,            Y, Y, Y, Y),
            "MatMulSlice":      (self.test_MatMulSlice,       Y, Y, Y, Y),
            "MatMulSplit":      (self.test_MatMulSplit,       N, Y, N, Y),
            "Max":              (self.test_Max,               Y, Y, N, Y),
            "MaxPool1d":        (self.test_MaxPool1d,         Y, Y, Y, Y),
            "MaxPool2d":        (self.test_MaxPool2d,         Y, Y, Y, Y),
            "MaxPool3d":        (self.test_MaxPool3d,         Y, Y, Y, Y),
            "MeshGrid":         (self.test_MeshGrid,          N, N, N, Y),
            "Min":              (self.test_Min,               Y, Y, N, Y),
            "MM":               (self.test_MM,                Y, Y, Y, Y),
            "MV":               (self.test_MV,                Y, N, N, Y),
            "Mul":              (self.test_Mul,               Y, Y, Y, Y),
            "MulConst":         (self.test_MulConst,          Y, Y, Y, Y),
            "NewZeros":         (self.test_NewZeros,          Y, Y, Y, Y),
            "NonZero":          (self.test_NonZero,           Y, Y, N, N),
            # "Normalize":        (self.test_Normalize,         Y, Y, N, N),
            "New_full":         (self.test_New_full,          Y, Y, Y, Y),
            "Reduce":           (self.test_Reduce,            Y, Y, Y, Y),
            "Remainder":        (self.test_Remainder,         Y, N, N, Y),
            "Repeat":           (self.test_Repeat,            Y, Y, Y, Y),
            "Reshape":          (self.test_Reshape,           Y, Y, Y, Y),
            "ReshapeConcat":    (self.test_ReshapeConcat,     Y, Y, Y, Y),
            "Depth2Space":      (self.test_D2SPattern,        Y, Y, N, Y),
            "RMSNorm":          (self.test_RMSNorm,           Y, Y, N, Y),
            "RoiAlign":         (self.test_RoiAlign,          Y, Y, N, N),
            "Roll":             (self.test_Roll,              Y, Y, N, Y),
            "PixelShuffle":     (self.test_PixelShuffle,      Y, Y, Y, Y),
            "PixelUnshuffle":   (self.test_PixelUnshuffle,    Y, Y, Y, Y),
            "PRelu":            (self.test_PRelu,             Y, Y, Y, Y),
            "Permute":          (self.test_Permute,           Y, Y, Y, Y),
            "Permute2":         (self.test_Permute2,          Y, Y, N, Y),
            "Pad1d":            (self.test_Pad1d,             Y, Y, Y, Y),
            "Pad2d":            (self.test_Pad2d,             Y, Y, Y, Y),
            "Pad_MultiCore":    (self.test_Pad_MultiCore,     Y, Y, Y, Y),
            "Pow":              (self.test_Pow,               Y, Y, Y, Y),
            "Scatter":          (self.test_Scatter,           N, N, N, N),
            "ScaleDotAtten":    (self.test_ScaleDotAtten,     Y, N, N, Y),
            "Select":           (self.test_Select,            Y, Y, Y, Y),
            "Sign":             (self.test_Sign,              Y, Y, N, Y),
            "Slice":            (self.test_Slice,             Y, Y, Y, Y),
            "Slice_MultiCore":  (self.test_Slice_MultiCore,   Y, Y, Y, Y),
            "Softmax":          (self.test_Softmax,           Y, Y, Y, Y),
            "Softmin":          (self.test_Softmin,           Y, Y, Y, Y),
            "Split":            (self.test_Split,             Y, Y, Y, Y),
            "Squeeze":          (self.test_Squeeze,           Y, Y, Y, Y),
            "Stack":            (self.test_Stack,             Y, Y, Y, Y),
            "Sub":              (self.test_Sub,               Y, Y, Y, Y),
            "T":                (self.test_T,                 Y, Y, Y, Y),
            "Tile":             (self.test_Tile,              Y, Y, Y, Y),
            "To":               (self.test_To,                Y, Y, Y, Y),
            "Type_as":          (self.test_Type_as,           Y, Y, Y, Y),
            "Transpose":        (self.test_Transpose,         Y, Y, Y, Y),
            "Unbind":           (self.test_Unbind,            Y, Y, Y, Y),
            "Upsample":         (self.test_Upsample,          Y, Y, Y, Y),
            "Unary":            (self.test_Unary,             Y, Y, Y, Y),
            "Unsqueeze":        (self.test_Unsqueeze,         Y, Y, Y, Y),
            "View":             (self.test_View,              Y, Y, Y, Y),
            "Where":            (self.test_Where,             Y, Y, N, Y),
            ## Special Case
            "Connect":          (self.test_Connect,           N, N, N, N),
            "GatherMulConst":   (self.test_GatherMulConst,    Y, Y, N, Y),
            "InfError":         (self.test_InfError,          Y, Y, N, Y),
            "SplitReshape":     (self.test_SplitReshape,      Y, Y, Y, Y),
            ...
            ## Canonicalization
            "MovePermuteAfterAdd": (self.test_MovePermuteAfterAdd, Y, Y, N, Y),
            "Conv2Img2Col": (self.test_Conv2Img2Col, Y, Y, N, Y),
            "SplitMatMul": (self.test_SplitMatMul, Y, Y, N, Y),
            "InputGather": (self.test_InputGather, Y, Y, N, Y)
        }
        # yapf: enable
...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--chip", default="bm1684x", type=str,
                        choices=['bm1684x', 'bm1688', 'cv183x', 'cv184x', 'cv186x', 'bm1690', 'bm1690e','sgtpuv8', 'bm1684x2'], help="chip platform name")
