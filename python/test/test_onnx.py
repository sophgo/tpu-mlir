...
class ONNX_IR_TESTER(object):
    ...
    def __init__(self,
        ...
        self.test_cases = {
            ...
            "Einsum13":     (self.test_Einsum13,      N, Y, N, N, Y),
            "Einsum14":     (self.test_Einsum14,      N, Y, Y, N, Y),
    ...
    def check_support(self, case):
        _, bm1684_support, bm1684x_support, bm1688_support, cv183x_support, bm1690_support = self.test_cases[
            case]
