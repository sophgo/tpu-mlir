...
class ONNX_IR_TESTER(object):
    ...
    def __init__(self,
        ...
        self.test_cases = {
            ...
            "Flatten":      (self.test_Flatten,       Y, Y, N, Y, Y, Y, N),
            ...
            "Reshape":      (self.test_Reshape,       Y, Y, N, N, Y, Y, N),
            ...
            "Squeeze":      (self.test_Squeeze,       Y, Y, N, Y, Y, Y, N),
            ...
            "Unsqueeze":    (self.test_Unsqueeze,     Y, Y, N, N, Y, Y, N),
