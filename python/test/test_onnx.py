...
class ONNX_IR_TESTER(object):
    ...
    def __init__(self,
        ...
        self.test_cases = {
            ...
            "PadAvgPool2d": (self.test_PadAvgPool2d,  Y, Y, N, Y),
            "BatchMatMul":  (self.test_BatchMatMul,   N, Y, N, Y),
            ...
            "Concat":       (self.test_Concat,        Y, Y, N, Y),
            "Concat2":      (self.test_Concat2,       Y, Y, N, Y),
            "Concat3":      (self.test_Concat3,       N, Y, N, N),
            "ConstOfShape": (self.test_ConstOfShape,  N, Y, N, N),
            "Conv1d":       (self.test_Conv1d,        N, Y, N, Y),
            ...
            "Deconv":       (self.test_Deconv,        N, Y, N, N),
            "Div":          (self.test_Div,           N, Y, Y, Y),
            "DivBcast":     (self.test_DivBcast,      N, Y, Y, N),
            "DivBcast2":    (self.test_DivBcast2,     N, Y, Y, N),
            "Einsum":       (self.test_Einsum,        N, Y, Y, Y),
            "Einsum2":      (self.test_Einsum2,       N, Y, Y, Y),
            ...
            "LSTM3":        (self.test_LSTM3,         N, Y, Y, Y),  # output_yh and output_yc
            "MaxPool1d":    (self.test_MaxPool1d,     Y, Y, Y, Y),
            "MaxPool2d":    (self.test_MaxPool2d,     Y, Y, Y, Y),
            "MaxPool3d":    (self.test_MaxPool3d,     N, N, Y, Y),
            ...
            "MulMerge":     (self.test_MulMerge,      Y, Y, N, N),
            ...
            "ReduceL2":     (self.test_ReduceL2,      N, Y, Y, Y),
            ...
            "Slice3":       (self.test_Slice3,        N, Y, Y, Y),
            "Split":        (self.test_Split,         N, Y, Y, Y),
            "Scale":        (self.test_Scale,         Y, Y, Y, Y),
            "Sqrt":         (self.test_Sqrt,          N, Y, Y, Y),
            ...
            "SubConst":     (self.test_SubConst,      N, Y, Y, N),
            "SubConst2":    (self.test_SubConst2,     N, Y, Y, Y),
            ...
            #####################################
            # case: (test, bm1684_support, bm1684x_support, bm1686_support, cv183x_support)
            "TorchActivation":      (self.test_TorchActivation,     N, N, Y, Y),
            ...
            "TorchGelu":            (self.test_TorchGelu,           N, Y, Y, Y),
            ...
            "MatMulTranspose":  (self.test_MatMulTranspose, N, Y, N, Y),
            "MatMulTranspose2":  (self.test_MatMulTranspose2, N, Y, N, Y),
            "MatMulTranspose3":  (self.test_MatMulTranspose3, N, Y, N, Y),
            "PadConv1d":        (self.test_PadConv1d,       N, N, N, Y),
            "PadConv2d":        (self.test_PadConv2d,       Y, Y, Y, Y),
            "PadConv3d":        (self.test_PadConv3d,       N, N, N, N),
            "PadPool1d":        (self.test_PadPool1d,       N, N, Y, Y),
            ...
            "PermuteBinary":    (self.test_PermuteBinary,   N, Y, N, Y),
            ...
            "SwapDimInner":     (self.test_SwapDimInner,    N, Y, Y, N),
