...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", default="f16", type=str, choices=['f16', 'bf16'], help="quantize modes")
    ...
    parser.add_argument("--file_path", default="/workspace/Qwen2-VL-7B-Instruct-GPTQ-Int4/weights/qwen2vl_decoder_layer_0_quantized.pth",
                        type=str, help="path for quantized weights")
    parser.add_argument("--cos_sin_path", default="/workspace/Qwen2-VL-7B-Instruct-GPTQ-Int4/weights/cos_sin_tensor.pth",
                        type=str, help="path for rotary_emb: output as {'cos': cos, 'sin': sin}")
    args = parser.parse_args()

    tester = qwen2.utils.TPULANG_CONVERTER(args.chip, args.mode, args.file_path, args.cos_sin_path, args.quant_bits, args.seq_len)
