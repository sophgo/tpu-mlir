...
def parse_args():
    parser = argparse.ArgumentParser(description='Inference resnet50 network.')
...
def postprocess(output, img, category_file, top_k=5):
    prob = output['resnetv24_dense0_fwd_Gemm'] # according to the network output
