...
class MixQuantModel:
    ...
    def infer(self, data: list):
        for k, v in zip(self.model.input_names, data):
...
class MixPrecSearcher(object):
    ...
    def __init__(self, args):
        ...
        self.parser = MlirParser(self.mlir_file)
    ...
    def _init_inputs(self, args):
        ...
        if ds.all_image:
            ...
            self.input_data_buffer = [[] * self.num_sample]
            batched_idx = 0
            ...
            for data in ds.data_list:
                ...
                for name in input_names:
                    self.input_data_buffer[sample_idx].append(npz[name])
        else:
    ...
    def run(self):
        ...
        for op in pbar:
            ...
            mix_model = MixQuantModel(self.fp32_mlir, False, self.calib_table, mix_table)
            loss = 0
            for idx in range(self.num_sample):
