...
class TIU:
    ...
    def __init__(self, dirpath):
        ...
        self.columns = [
            ...
            'Subnet Type', 'File Line', 'Function Type', 'Function Name', 'Alg Cycle', 'Alg Ops',
            'Asic Cycle', 'Start Cycle', 'End Cycle', 'uArch Ops', 'uArch Rate',
            'Bank Conflict Ratio', 'Initial Cycle Ratio', 'Data Type', 'Sim Power(W)',
            'des_cmd_id_dep', 'des_res0_n', 'des_res0_c', 'des_res0_h', 'des_res0_w',
            'des_res0_n_str', 'des_res0_c_str', 'des_res0_h_str', 'des_res0_w_str', 'des_opd0_n',
            'des_opd0_c', 'des_opd0_h', 'des_opd0_w', 'des_opd0_n_str', 'des_opd0_c_str',
            'des_opd0_h_str', 'des_opd0_w_str', 'des_opd1_c', 'des_opd1_h', 'des_opd1_w',
            'des_opd1_n_str', 'des_opd1_c_str', 'des_opd1_h_str', 'des_opd1_w_str',
            'des_opd2_n_str', 'des_res0_addr', 'des_res1_addr', 'des_opd0_addr', 'des_opd1_addr',
            'des_opd2_addr', 'des_opd3_addr', 'des_tsk_typ', 'des_tsk_eu_typ', 'des_cmd_short',
            'des_opt_res0_prec', 'des_opt_opd0_prec', 'des_opt_opd1_prec', 'des_opt_opd2_prec',
            'des_short_opd0_str', 'des_opt_opd0_const', 'des_opt_opd1_const', 'des_opt_opd2_const',
            'des_opt_opd3_const', 'des_opt_opd4_const', 'des_opt_opd5_const', 'des_opt_res_add',
            'des_opt_res0_sign', 'des_opt_opd0_sign', 'des_opt_opd1_sign', 'des_opt_opd2_sign',
            'des_opd0_rt_pad', 'des_opd1_x_ins0', 'des_opd0_up_pad', 'des_opd0_lf_pad',
            'des_opt_left_tran', 'des_pad_mode', 'des_opd0_y_ins0', 'des_opd1_y_ins0',
            'des_short_res0_str', 'des_short_opd1_str', 'des_sym_range', 'des_opt_rq',
            'des_op_code', 'des_opt_kernel_rotate', 'des_res_op_x_str', 'des_res_op_y_str',
            'des_opd0_x_ins0', 'des_tsk_opd_num', 'des_opd0_dn_pad', 'des_intr_en', 'des_opt_relu',
            'des_pwr_step', 'Msg Id', 'Sd\Wt Count', 'is_local'
        ]
    ...
    def process_data(self, coreId, layer_map):
        ...
        for i in range(len(new_regList)):
            ...
            if regDict['Asic Cycle'].isnumeric() and not (regDict['des_tsk_typ'] == '15'
                                                          and regDict['des_tsk_eu_typ'] == '9'):
        ...
        groups = [[
            'des_res0_n', 'des_res0_c', 'des_res0_h', 'des_res0_w', 'des_opt_res0_prec',
            'des_res0_size'
        ],
                  [
                      'des_opd0_n', 'des_opd0_c', 'des_opd0_h', 'des_opd0_w', 'des_opt_opd0_prec',
                      'des_opd0_size'
                  ],
                  [
                      'des_opd1_n', 'des_opd1_c', 'des_opd1_h', 'des_opd1_w', 'des_opt_opd1_prec',
                      'des_opd1_size'
                  ]]
