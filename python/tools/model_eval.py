...
parser = argparse.ArgumentParser(description="Evaluation on ImageNet Dataset.")
...
parser.add_argument("--dataset_type",
                    type=str,
                    default='imagenet',
                    choices=['imagenet', 'coco', 'voc', 'user_define'],
...
if __name__ == '__main__':
    ...
    if args.dataset_type == 'imagenet':
        val_loader = torch.utils.data.DataLoader(MyImageFolder(args.dataset),
                                                 batch_size=1,
                                                 shuffle=False,
                                                 num_workers=1,
                                                 pin_memory=True,
