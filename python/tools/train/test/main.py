...
if __name__ == '__main__':
    ...
    parser.add_argument("--chip",
                        default="bm1690",
                        choices=['bm1684x', 'bm1690', 'sg2260'],
                        help="chip name")
    parser.add_argument(
        "--debug",
        default="const_name,print_ori_fx_graph",  #dump_bmodel_input,save_fx_graph_dot
        help="debug")
    ...
    parser.add_argument("--opt", default=3, type=int, help='layer group opt')
    ...
    parser.add_argument("--test_input",
                        default="../fwd_bmodel_inputs.npz,../bwd_bmodel_inputs.npz",
                        help="test input")  #
    ...
    if args.model == "test":
        ...
        if args.fast_test:
            ...
            in_size2 = 4
        if args.fp == "fp16":
            mod = StableDiffusionPipeline.from_pretrained(model_id,
        ...
        for name in unet.attn_processors.keys():
            ...
            print('name:', name, 'cross_attention_dim:', cross_attention_dim, 'hidden_size:',
                  hidden_size)
        ...
        class sd_module(nn.Module):
            ...
            def forward(self, noise, vae_input, timesteps, input_id, alphas_cumprod):
                ...
                noisy_latents = self.noise_scheduler(latents.to(device), noise, timesteps,
                                                     alphas_cumprod)
        ...
        clip_input = cliptokenizer(example_text,
                                   padding='max_length',
                                   max_length=10,
                                   truncation=True,
                                   return_tensors="pt")
