...
def check_forward(variables, with_cuda, verbose, sparse):
    if with_cuda:
        if not torch.cuda.is_available():
            ...
            cuda_values = fpemu_cuda.FPEmuOp.apply(variables.cuda(),
                                                   "FP4_NEAREST")  #, False, 1.0, True, 4)
...
kwargs = {'dtype': torch.float32, 'device': device, 'requires_grad': True}
'''
#FP4 values 
...
input = torch.tensor(np.array([[
    57344.00, -61440.0, 65504.0, -500.0, 448.0, -480.0, 30.0, -31.0, 26.0, 15.0, -7.6505613e-00,
    5.9832452e-00, 1.5625032e-02, 3.1725775e-02, 4.3268750e-02, 6.2655000e-02, 1.9545313e-03,
    3.9045625e-03, 5.8845638e-03, 7.8089750e-03, -6.0151856e-02, 6.9784373e-03, -1.6634936e+03,
    -7.6505613e-04, 1.9545313e-03, 3.9045625e-03, 5.8845638e-03, 7.8089750e-03, 1.5629950e-02,
    1.5225650e-02, -3.1256500e-02, 9.3857500e-02, 7.9284608e-01, 2.8815269e-01, -1.1787039e-01,
    6.1035156e-05, -1.1787039e-06, -1.0749481e-01, -1.3085605e+00, 6.5981364e-01, -7.0325255e-02,
    2.7448297e-01, 5.5694544e-01, -2.3220782e-01, -5.9746221e-02, 15.23213444, -0.00004323,
    1.9767435e-04, -1.2203161e+00, 2.9099861e-01, -7.9642259e-02, 1.3200364e+00, -1.5196867e+00,
    -1.2530587e+00, -2.0159689e-03, -1.9767643e+00, 6.0834163e-04, 7.8943473e-05, 7.8247029e-04,
    -6.4658634e-05, -2.3020705e-06, -1.5630834e-05, -7.4762434e-07, 2.1336775e-06
]]),
                     dtype=torch.float32)
#'''
