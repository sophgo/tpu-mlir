...
for t in range(epoch_num):
    ...
    total_loss = train_loop(train_dataloader, model_prepared11, loss_fn, optimizer, lr_scheduler,
                            t + 1, total_loss)
...
for t in range(epoch_num):
    print(f"Epoch {t+1}/{epoch_num}\n-------------------------------")
    total_loss = train_loop(train_dataloader, model_prepared1, loss_fn, optimizer1, lr_scheduler1,
                            t + 1, total_loss)
