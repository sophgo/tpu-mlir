...
def show_domain_record(domain_record):
    print(
        f"STEM\t{domain_record['STEM']['correct']}\t{domain_record['STEM']['total']}\t{(domain_record['STEM']['correct']/domain_record['STEM']['total'])}"
    )
    print(
        f"Social_Science\t{domain_record['Social_Science']['correct']}\t{domain_record['Social_Science']['total']}\t{(domain_record['Social_Science']['correct']/domain_record['Social_Science']['total'])}"
    )
    print(
        f"Humanities\t{domain_record['Humanities']['correct']}\t{domain_record['Humanities']['total']}\t{(domain_record['Humanities']['correct']/domain_record['Humanities']['total'])}"
    )
    print(
        f"Other\t{domain_record['Other']['correct']}\t{domain_record['Other']['total']}\t{(domain_record['Other']['correct']/domain_record['Other']['total'])}"
    )
