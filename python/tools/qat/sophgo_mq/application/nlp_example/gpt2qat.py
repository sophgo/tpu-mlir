...
parser.add_argument('--wd',
                    ...
                    dest='wd')
parser.add_argument('--wbit', default=4, type=int, metavar='wbit', help='weight bit')
...
main_data['train_data'] = main_data['Question'] + '<cont>' + main_data[
    'Context'] + '<ans>' + main_data['Answer']
...
cali_loader = DataLoader(cali_loader, sampler=SequentialSampler(cali_loader), batch_size=2)
test_dataloader = DataLoader(testdataset, sampler=RandomSampler(testdataset), batch_size=batch_size)
#load model
...
#train parameters
optimizer = AdamW(model_prepared1.parameters(), lr=learning_rate, eps=epsilon)
...
optimizer1 = AdamW(model_prepared11.parameters(), lr=learning_rate, eps=epsilon)
...
model_prepared2, training_stats1 = train(model_prepared11, epochs, optimizer1, scheduler1,
...
model_prepared3, training_stats2 = train1(model_prepared1, epochs, optimizer, scheduler,
                                          train_dataloader, validation_dataloader)
