        ...
        try:
            ...
            if ('.weight_fake_quant' in name):
                ...
                if isinstance(upper_layer, valid_layers):
                    ...
                    setattr(
                        upper_layer.weight_fake_quant, 'H',
                        torch.zeros(layer_module.weight.data.shape[1],
                                    layer_module.weight.data.shape[1]))
                else:
...
validation_dataloader = DataLoader(
    ...
    collate_fn=data_collator)
cali_loader = DataLoader(tokenized_cali, shuffle=False, batch_size=1, collate_fn=data_collator)
