#loc = loc(unknown)
#loc1 = loc("BMTensor0")
module @Yuv2rgb_0 attributes {module.FLOPs = 0 : i64, module.addr_mode = "basic", module.asymmetric = true, module.chip = "bm1684x", module.cores = 1 : i64, module.devices = 1 : i64, module.inputs = ["BMTensor0"], module.mode = "INT8", module.outputs = ["yuv2rgb_cd66f5ba-4fa5-4944-a716-beabb865689a"], module.platform = "TPULANG", module.q_group_size = 0 : i64, module.state = "TPU_ADDRESSED", module.top_run_mode = "STATIC", module.weight_file = "yuv2rgb_0_tpu_addressed_bm1684x_int8_asym_weight.npz"} {
  module @Yuv2rgb_0 attributes {module.coeff_addr = 4294967296 : i64, module.coeff_size = 0 : i64, module.device_id = 0 : i64, module.neuron_addr = 4294967296 : i64, module.neuron_size = 49152 : i64, module.step = 0 : i64} {
...
#loc2 = loc("yuv2rgb_cd66f5ba-4fa5-4944-a716-beabb865689a")
