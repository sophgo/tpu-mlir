...
class SG2260Runner(CModelRunner):
    ...
    def __init__(self, memory_size, base_addr: Tuple[int, int]):
        ...
        super().__init__()
        self.base_addr = base_addr  # a list contains several base_addr, each one is manully set in SG2260Context, which represent the base_addr of 2 tags {TAG_WEIGHT,TAG_ACTIVATION} above.
        self.core_num = 8
