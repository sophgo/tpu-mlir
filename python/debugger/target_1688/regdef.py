...
# ==============================================================================
#
# automatically generated by /workspace/tpu-mlir/python/debugger/target_1688/xlsx_to_py.py
# time: 2023-10-11 05:27:54
# this file should not be changed except format.
# tiu_reg_fn: ./Athena2_TPU_TIU_Reg3.2.xlsx
# dma_reg_fn: ./GDMA_A2_DES_REG_v2.7.xlsx
...
class DMA_compress_reg(atomic_reg):
    ...
    _fields_ = [
        ...
        ("racu_start_addr_h8", ctypes.c_uint64, 8),
        ("reserved", ctypes.c_uint64, 24),
        ("meta_start_addr_l32", ctypes.c_uint64, 32),
        ("meta_start_addr_h8", ctypes.c_uint64, 8),
        ("reserved", ctypes.c_uint64, 24),
        ("localmem_mask_l32", ctypes.c_uint64, 32),
        ("localmem_mask_h32", ctypes.c_uint64, 32),
    ]
    ...
    racu_start_addr_h8: int
    reserved: int
    meta_start_addr_l32: int
    meta_start_addr_h8: int
    reserved: int
    localmem_mask_l32: int
    localmem_mask_h32: int
