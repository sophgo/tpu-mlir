...
tiu_reg_mars3 = "./Mars3_TPU_TIU_Reg0.21.xlsx"
dma_reg_mars3 = "./GDMA_Mars3_DES_REG.xlsx"
...
reg_bdc = pandas.read_excel(tiu_reg_mars3, sheet_name=bdc_sheet_name)
reg_dma = pandas.read_excel(dma_reg_mars3, sheet_name=dma_sheet_name)
...
# tiu_reg_fn: {tiu_reg_mars3}
# dma_reg_fn: {dma_reg_mars3}
