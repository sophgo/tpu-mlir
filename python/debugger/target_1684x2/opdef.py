...
class TiuCmd(BaseTpuCmd, Tiu):
    opparam_converter = None  # assigned by BM1684X2Context instance
    ...
    def __init__(
        ...
        *,
        ...
        self.cmd_id = cmd_id
        # cmd_id_dep of SYS_TR_WR_reg will be assigned in merge_instruction
...
class conv_dw_op(TiuCmd):
    name = "CONV_DW"
    opcode = 0
    eu_type = {1: "conv.dw", 4: "conv.dw.tf32"}
    description = "convolution"
...
class sconv_dw_op(conv_dw_op):
    name = "sCONV_DW"
    short_cmd = True
    description = "short depthwise convolution"
...
class sreduce_op(reduce_op):
    name = "sREDUCE"
    short_cmd = True
    description = "short reduce"
...
class sg_op(TiuCmd):
    ...
    eu_type = {
        ...
        # 2: "sg.pl_gather_rec", # not sure if is currently supported, not writen (Y) in BM1684X2 xlsx
...
class srand_op(rand_op):
    name = "sPRNG"
    short_cmd = True
    description = "short prng"
