...
class Decoder(DecoderBase):
    ...
    def __init__(self, context: "BM1684X2Context") -> None:
        super().__init__()
        self.context = context

    def decode_tiu_cmd(self, reg_buf: memoryview, *, offset, core_id, cmd_id, subnet_id):
        assert cmd_id is not None, "TDB only support cmd id mode."
    ...
    def decode_cmds(self, cmd_arry: bytes, core_id: int, cmd_id: int, t: int) -> list:
        ...
        if t == EngineType.TPU:
            ...
            assert False, "HAU and other dynamic engine not supported yet." + str(t)
