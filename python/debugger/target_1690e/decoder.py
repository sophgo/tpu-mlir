...
from .regdef import DMA_sys_reg as dma_sys, sSYS_reg as tiu_sys, sCDMA_sys_reg as cdma_sys
...
class Decoder(DecoderBase):
    ...
    def __init__(self, context: "BM1690EContext") -> None:
        super().__init__()
        self.context = context

    def decode_tiu_cmd(self, reg_buf: memoryview, *, offset, core_id, cmd_id, subnet_id):
        assert cmd_id is not None, "2260e must assign cmd_id manully"
