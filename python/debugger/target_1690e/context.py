...
import numpy as np
from .regdef import DMA_sys_reg as dma_sys, sSYS_reg as tiu_sys, SYS_TR_WR_reg as SYS_TR_ACC_reg, sCDMA_sys_reg as cdma_sys
from .memmap import *
from .decoder import Decoder
from typing import List, Type
from .cmodel import BM1690ERunner
...
class BM1690EContext(BModelContext):
    device = Target.BM1690E
    ...
    def get_runner(self, memory_size: int) -> CModelRunner:
        assert self.using_cmodel, "2260e currently only support cmodel mode"
        if self._runner is None:
            self._runner = BM1690ERunner(memory_size, self.base_addr)
        return self._runner
