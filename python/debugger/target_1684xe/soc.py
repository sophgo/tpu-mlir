...
from debugger.target_1684xe import *
from debugger.target_1684xe.memmap import *
from debugger.target_common import *
from debugger.target_common.op_support import *


class BM1684XERunner(DeviceRunner):
    lib_name = "libatomic_exec_aarch64.so"
    soc_structs = []
    kernel_fn = os.path.join(
        os.environ["PROJECT_ROOT"], "debugger/lib/libbm1684xe_atomic_kernel.so" # do not use libbm1684xe_kernel_module, which may cause nan error
    )
