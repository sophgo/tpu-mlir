...
class BM1684XERunner(DeviceRunner):
    ...
    soc_structs = []
    kernel_fn = os.path.join(os.environ["TPUC_ROOT"], "lib/libbm1684xe_atomic_kernel.so") # do not use libbm1684x_kernel_module, which may cause nan error
    ...
    def checker_fast_compute_soc(self, cmd_group: StaticCmdGroup):
        ...
        BM1684XERunner.soc_structs.append(
