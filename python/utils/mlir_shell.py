...
def mlir_lowering(top_mlir: str,
    ...
    lower_param = "--convert-top-to-tpu=\"mode={} {} asymmetric={} linear_quant_mode={} ignore_f16_overflow={}\"".format(
        mode, qtable, asymmetric, linear_quant_mode, ignore_f16_overflow)
    cmd.extend([
        lower_param,
        "--canonicalize",
        "-o",
