...
.. list-table:: Function of model_deploy parameters
   ...
   * - opt_post_processor
     - N
     - Specify whether to further optimize the results of LayerGroup. Supported on CV184X. Default is "none", no opt
   * - lgcache
     - N
   ...
   * - addr_mode
     - N
     - set address assign mode ['auto', 'basic', 'io_alone', 'io_tag_fuse', 'io_reloc', 'in_reuse'], if not set, auto as default
   * - disable_layer_group
     - N
