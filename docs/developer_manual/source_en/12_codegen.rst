...
The instructions differ based on the processor's engine, e.g., 1684 has GDMA and TIU, while newer architecture processors have additional engines such as sdma, cdma, etc. Using the most common engines, BDC (later renamed to TIU) and GDMA, as examples:
