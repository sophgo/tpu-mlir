...
Value top::ReluOp::lowering_int8_bm1686(bool asymetric) {
  return lowering_common_int8<tpu::ReluOp>(getOperation());
}

Value top::ReluOp::lowering_f32_bm1686() {
  return lowering_common<tpu::ReluOp>(getOperation());
}

Value top::ReluOp::lowering_bf16_bm1686() {
  return lowering_common<tpu::ReluOp, BFloat16Type>(getOperation());
}

Value top::ReluOp::lowering_f16_bm1686() {
