...
void AddPostprocessPass::getYoloOperandsAndAnchors(
  ...
  if ((post_type == "yolov8_seg" || post_type == "yolov11_seg") && num_opds == 2) {
    operands.push_back(opds[0]);
...
void AddPostprocessPass::insertYolosegOp(OpBuilder &builder) {
  ...
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr(offsets)));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr(ends)));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr(steps)));
  ...
  auto coeff_type = RankedTensorType::get({1,1,p_shape[2]}, builder.getF32Type());
  auto weight_p4_plus_op1 = WeightOp::create(slice_op1, "weight_p4_plus_op1", weight_p4_plus, coeff_type);
  ...
  new_type = RankedTensorType::get({p_shape[0], nc + 1, p_shape[2]},
  ...
  attrs.clear();
  attrs.push_back(
      builder.getNamedAttr("axes", builder.getI64ArrayAttr({1})));
  attrs.push_back(
      builder.getNamedAttr("keepdims", builder.getBoolAttr(false)));
  attrs.push_back(
  ...
  auto reduce_max_op1 =
          builder.create<ReduceOp>(new_loc, new_type, concat_op_p4.getOutput(), attrs);
  attrs.clear();
  ...
  auto compare_const_op1 =
          builder.create<CompareConstOp>(new_loc, new_type, reduce_max_op1.getOutput(), attrs);
  attrs.clear();
  attrs.push_back(
  ...
  auto permute_op1 =
          builder.create<PermuteOp>(new_loc, new_type, predication_op.getOutput(), attrs);
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 0, 0})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr(steps)));
  slice_shape = {p_shape[0], p_shape[2], 4};
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({slice_shape})));
  ...
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 0, 4})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr(steps)));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[0], p_shape[2], p_shape[1]})));
  new_type = module::getTypeLike(predication_op.getOutput(), slice_shape);
  ...
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 0, 2})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr(steps)));
  slice_shape = {p_shape[0], p_shape[2], 1};
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[0], p_shape[2], 3})));
  auto dim3_type = module::getTypeLike(predication_op.getOutput(), slice_shape); // 1,8400

  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_slice1"));
  ...
  auto dim2_type = module::getTypeLike(predication_op.getOutput(), single_dim_shape); //1,8400
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_squeeze1"));
  auto squeeze_op1 =
          builder.create<ReshapeOp>(new_loc, dim2_type, xywh2xyxy_slice1_op.getOutput(), attrs);

  attrs.clear();
  attrs.push_back(
      builder.getNamedAttr("const_val", builder.getF64FloatAttr(0.5)));
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_mulconst1"));
  auto mulconst_op1 =
          builder.create<MulConstOp>(new_loc, dim2_type, squeeze_op1.getOutput(), attrs);

  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 0, 3})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr(steps)));
  slice_shape = {p_shape[0], p_shape[2], 1};
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[0], p_shape[2], 4})));
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_slice2"));
  auto xywh2xyxy_slice2_op =
          builder.create<SliceOp>(new_loc, dim3_type, xywh2xyxy_operands, attrs);

  attrs.clear();
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_squeeze2"));
  auto squeeze_op2 =
          builder.create<ReshapeOp>(new_loc, dim2_type, xywh2xyxy_slice2_op.getOutput(), attrs);

  attrs.clear();
  attrs.push_back(
      builder.getNamedAttr("const_val", builder.getF64FloatAttr(0.5)));
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_mulconst2"));
  auto mulconst_op2 =
          builder.create<MulConstOp>(new_loc, dim2_type, squeeze_op2.getOutput(), attrs);
  ...
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_slice3"));
  auto xywh2xyxy_slice3_op =
          builder.create<SliceOp>(new_loc, dim3_type, xywh2xyxy_operands, attrs);

  attrs.clear();
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_squeeze3"));
  auto squeeze_op3 =
          builder.create<ReshapeOp>(new_loc, dim2_type, xywh2xyxy_slice3_op.getOutput(), attrs);
  ...
  auto sub_op1 =
        builder.create<SubOp>(new_loc, dim2_type, operands, attrs);

  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 0, 1})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr(steps)));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[0], p_shape[2], 2})));

  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_slice4"));

  auto xywh2xyxy_slice4_op =
          builder.create<SliceOp>(new_loc, dim3_type, xywh2xyxy_operands, attrs);

  attrs.clear();
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_squeeze4"));
  auto squeeze_op4 =
          builder.create<ReshapeOp>(new_loc, dim2_type, xywh2xyxy_slice4_op.getOutput(), attrs);
  ...
  auto add_op1 =
        builder.create<AddOp>(new_loc, dim2_type, operands, attrs);
  ...
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_unsqueeze1"));
  auto un_squeeze_op1 =
        builder.create<UnsqueezeOp>(new_loc, dim3_type, sub_op1.getOutput(), attrs);
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_unsqueeze2"));
  auto un_squeeze_op2 =
        builder.create<UnsqueezeOp>(new_loc, dim3_type, sub_op2.getOutput(), attrs);
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_unsqueeze3"));
  auto un_squeeze_op3 =
        builder.create<UnsqueezeOp>(new_loc, dim3_type, add_op1.getOutput(), attrs);
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_xywh2xyxy_unsqueeze4"));
  auto un_squeeze_op4 =
        builder.create<UnsqueezeOp>(new_loc, dim3_type, add_op2.getOutput(), attrs);
  attrs.clear();
  ...
  auto new_type2 = RankedTensorType::get({ p_shape[2], p_shape[1]},
                                      module::getElementType(predication_op));  //8400 116
  auto squeeze_op5 =
          builder.create<ReshapeOp>(new_loc, new_type2, concat_op1.getOutput(), attrs); //x

  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_squeeze6"));
  new_type = RankedTensorType::get({p_shape[2]},
                                      module::getElementType(predication_op));  //8400
  auto squeeze_op6 =
          builder.create<ReshapeOp>(new_loc, new_type, compare_const_op1.getOutput(), attrs);

  attrs.clear();
  attrs.push_back(builder.getNamedAttr("order", builder.getStringAttr("ColMajor")));
  ...
  auto non_zero_op1 =
          builder.create<NonZeroOp>(new_loc, new_type, squeeze_op6.getOutput(), attrs);
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("batch_dims", builder.getI64IntegerAttr(0)));
  ...
  operands.push_back(none);
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0,0})));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[2], 4})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr({1, 1})));
  ...
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0,4})));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[2], nc + 4})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr({1, 1})));

  new_type = RankedTensorType::get({p_shape[2], nc},
  ...
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0,nc+4})));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[2], p_shape[1]})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr({1, 1})));

  new_type = RankedTensorType::get({p_shape[2], nm},
  ...
  attrs.push_back(builder.getNamedAttr("mode", builder.getStringAttr("ArgMax")));
  attrs.push_back(builder.getNamedAttr("select_last_index", builder.getBoolAttr(false)));
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_cls_argmax"));

  std::vector<Type> argmax_type;
  argmax_type.push_back(RankedTensorType::get({p_shape[2], 1},
                                      module::getElementType(predication_op)));
  argmax_type.push_back(RankedTensorType::get({p_shape[2], 1},
                                      module::getElementType(predication_op)));
  ...
  auto argmax_op1 =
          builder.create<ArgOp>(fused_loc, argmax_type, clses_op.getOutput(), attrs);
  ...
  attrs.clear();
  auto dim1_type = module::getTypeLike(predication_op.getOutput(), {p_shape[2]}); //8400
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_squeeze7"));
  auto squeeze_op7 =
          builder.create<ReshapeOp>(new_loc, dim1_type, argmax_op1.getValues(), attrs);
  ...
  auto weight_c1_plus_op1 = WeightOp::create(slice_op1, "weight_c1_plus_op1", weight_c1_plus, coeff_type);
  ...
  auto compare_const_op2 =
          builder.create<CompareConstOp>(new_loc, dim1_type, c1_plus_concat_op.getOutput(), attrs);
  ...
  new_type = RankedTensorType::get({p_shape[2], 1},
                                      module::getElementType(predication_op));
  auto non_zero_op2 =
          builder.create<NonZeroOp>(new_loc, new_type, compare_const_op2.getOutput(), attrs);
  ...
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 5})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr({1, 1})));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[2], 6})));
  ...
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 4})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr({1, 1})));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[2], 5})));
  auto slice_op5 =
          builder.create<SliceOp>(new_loc, new_type, operands, attrs);
  ...
  new_type = RankedTensorType::get({p_shape[2], 1},
                                      module::getElementType(predication_op));
  auto mulconst_op3 =
          builder.create<MulConstOp>(new_loc, new_type, slice_op4.getOutput(), attrs);
  ...
  auto add_op3 =
          builder.create<AddOp>(new_loc, new_type, operands, attrs);

  attrs.clear();
  attrs.push_back(builder.getNamedAttr("axes", builder.getI64ArrayAttr({0})));

  new_type = module::getTypeLike(predication_op.getOutput(), {1, p_shape[2], 4});
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_unsqueeze6"));
  auto unsqueeze_op6 =
          builder.create<UnsqueezeOp>(new_loc, new_type, add_op3.getOutput(), attrs);
  ...
  auto conf_squeeze =
          builder.create<SqueezeOp>(new_loc, new_type, slice_op5.getOutput(), attrs);

  attrs.clear();
  attrs.push_back(builder.getNamedAttr("axes", builder.getI64ArrayAttr({0})));

  new_type = module::getTypeLike(predication_op.getOutput(), {1, p_shape[2]});
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_conf_unsqueeze1"));
  auto conf_unsqueeze1_op =
          builder.create<UnsqueezeOp>(new_loc, new_type, conf_squeeze.getOutput(), attrs);

  attrs.clear();
  attrs.push_back(builder.getNamedAttr("axes", builder.getI64ArrayAttr({0})));
  new_type = module::getTypeLike(predication_op.getOutput(), {1, 1, p_shape[2]});
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_conf_unsqueeze2"));
  auto unsqueeze_op7 =
          builder.create<UnsqueezeOp>(new_loc, new_type, conf_unsqueeze1_op.getOutput(), attrs);


  std::vector<_Float32> weight1(1,std::numeric_limits<_Float32>::max());
  coeff_type = RankedTensorType::get(1, builder.getF32Type());
  auto weight_op1 = WeightOp::create(unsqueeze_op7, "weight1", weight1, coeff_type);

  std::vector<_Float32> weight2(1, iou_thres);
  coeff_type = RankedTensorType::get(1, builder.getF32Type());
  auto weight_op2 = WeightOp::create(unsqueeze_op7, "weight2", weight2, coeff_type);

  std::vector<_Float32> weight3(1, 0.0);
  coeff_type = RankedTensorType::get(1, builder.getF32Type());
  auto weight_op3 = WeightOp::create(unsqueeze_op7, "weight3", weight3, coeff_type);

  attrs.clear();
  attrs.push_back(builder.getNamedAttr("center_point_box", builder.getI64IntegerAttr(0)));
  attrs.push_back(builder.getNamedAttr("max_output_size", builder.getI64IntegerAttr(10000)));
  operands.clear();
  ...
  auto nms_op =
        builder.create<NmsOp>(new_loc, new_type, operands, attrs);
  ...
  operands.push_back(none);
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 2})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr({1, 1})));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[2], 3})));
  new_type = RankedTensorType::get({p_shape[2], 1},
                                      module::getElementType(predication_op));  //8400 1
  ...
  attrs.clear();
  new_type = module::getTypeLike(predication_op.getOutput(), {p_shape[2]}); //8400
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_squeeze8"));
  auto squeeze_op8 =
          builder.create<ReshapeOp>(new_loc, new_type, slice_op7.getOutput(), attrs);


  attrs.clear();
  new_type = module::getTypeLike(predication_op.getOutput(), {proto_shape[1], mh , mw}); //32 160 160
  ...
  operands.push_back(none);
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 6})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr({1, 1})));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({p_shape[2], p_shape[1] - nc + 2})));
  new_type = RankedTensorType::get({p_shape[2], nm},
                                      module::getElementType(predication_op));  //8400 1
  ...
  auto reshape_op1 =
          builder.create<ReshapeOp>(new_loc, new_type, squeeze_op9.getOutput(), attrs);
  ...
  operands.push_back(none);
  new_type = module::getTypeLike(predication_op.getOutput(), {p_shape[2], mh*mw});
  ...
  auto sigmoid_op1 =
          builder.create<SigmoidOp>(new_loc, new_type, matmul_op1.getOutput(), attrs);

  new_type = module::getTypeLike(predication_op.getOutput(), {p_shape[2], mh, mw});
  new_loc = NameLoc::get(builder.getStringAttr("yolo_seg_post_reshape2"));
  auto reshape_op2 =
          builder.create<ReshapeOp>(new_loc, new_type, sigmoid_op1.getOutput(), attrs);
  ...
  attrs.clear();
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 0, 0})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr({1, 1, 1})));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({max_boxes, mh, mw})));
  ...
  attrs.push_back(builder.getNamedAttr("offset", builder.getI64ArrayAttr({0, 0})));
  attrs.push_back(builder.getNamedAttr("steps", builder.getI64ArrayAttr({1, 1})));
  attrs.push_back(builder.getNamedAttr("ends", builder.getI64ArrayAttr({max_boxes, 6})));
  new_type = RankedTensorType::get({max_boxes, 6},
                                      module::getElementType(predication_op));  //8400 1
