...
void top::EinsumOp::shape_inference() {
  ...
  if (mode == "a,b->ab")  {      // outer product
    ...
    module::setShapeOrVerify(getOutput(), {lhs_shape[0], lhs_shape[1], lhs_shape[2]});
    ...
    module::setShapeOrVerify(getOutput(), {lhs_shape[0], lhs_shape[2], lhs_shape[3], rhs_shape[3]});
    ...
    module::setShapeOrVerify(getOutput(), {lhs_shape[0], lhs_shape[2], rhs_shape[2]});
    ...
    module::setShapeOrVerify(getOutput(), {rhs_shape[0], rhs_shape[1], lhs_shape[2], lhs_shape[3]});
  } else if (mode =="abcde,afbc->abdef") {
    module::setShapeOrVerify(getOutput(), {lhs_shape[0], lhs_shape[1], lhs_shape[3], lhs_shape[4], rhs_shape[1]});
  } else {
