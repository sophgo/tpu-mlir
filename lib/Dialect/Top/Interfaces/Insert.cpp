...
int64_t top::InsertOp::getFLOPs() {
  return module::getNumElements(getOutput());
}

LogicalResult top::InsertOp::init(InferenceParameter &p) { return success(); }
void top::InsertOp::deinit(InferenceParameter &p) {}

LogicalResult top::InsertOp::inference(InferenceParameter &p) {
...
void top::InsertOp::shape_inference() {
