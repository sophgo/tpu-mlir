...
void tpu::MinOp::codegen_global_bm1684() {
  int input_num = getInputs().size();
  assert(input_num == 2);
  int op_code = BINARY_MIN;
...
int64_t tpu::MinOp::getBufferSize_bm1684(int64_t in_lmem_bytes,
...
void tpu::MinOp::codegen_local_bm1684(int64_t n_step, int64_t h_step,
...
uint32_t tpu::MinOp::dyn_codegen_global_bm1684(void* ir_layer_info) {
  llvm_unreachable("Not Implemented");
  return 0;
}
int64_t tpu::MinOp::get_fw_type_bm1684() {
  return -1;
}
