...
void tpu::SubOp::codegen_local_bm1684(int64_t n_step, int64_t h_step, local_sec_info_t &sec_info) {
  int64_t n, c, h, w;
  ...
  if (module::isUniformQuantized(getOutput())) {
    ...
    BM1684::instance().dl_nodechip_broadcast_binary_fix8b_forward_local(
        ...
        module::isWeight(getInputs()[0]), module::isWeight(getInputs()[1]),
        op_code, (int)multiplier_v->at(0), (int)multiplier_v->at(1), (uint8_t)rshift_v->at(0), (uint8_t)rshift_v->at(1), is_int8, sign, 0,
