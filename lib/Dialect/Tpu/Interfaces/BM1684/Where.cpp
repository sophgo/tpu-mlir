...
void tpu::WhereOp::codegen_global_bm1684() {
  ...
  if (module::isUniformQuantized(getOutput())) {
    ...
    BM1684::instance().dl_nodechip_select_fix8b(module::getAddress(getCond()), module::getAddress(getTbrn()),
                                              module::getAddress(getFbrn()), module::getAddress(getOutput()),
                                              0, out_n, out_c ,out_h ,out_w,
                                              out_n/cond_n, out_c/cond_c, out_h/cond_h, out_w/cond_h,
                                              0,0,0,0,
                                              0,0,0,0,
...
void tpu::WhereOp::codegen_local_bm1684(int64_t n_step, int64_t h_step,
  ...
  if (module::isUniformQuantized(getOutput())) {
    ...
    module::getNCHW(getOutput(), out_n, out_c, out_h, out_w);
    module::getNCHW(getCond(), cond_n, cond_c, cond_h, cond_w);
    BM1684::instance().dl_nodechip_select_fix8b_local(out_gi.out_addr, cond_shape, out_gi.buffer_addr,
