...
// int8
void tpu::SubOp::codegen_global_cv18xx(void *ctx, int64_t layer_id) {
  ...
  //        *backend_ctx, layer_id, ga_inputs.data(), ga_output, input_num, n,
  //        c, h, w, do_relu(), do_early_stride, early_stride_h, early_stride_w,
