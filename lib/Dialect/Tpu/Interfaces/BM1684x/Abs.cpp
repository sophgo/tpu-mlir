...
void tpu::AbsOp::codegen_global_bm1684x() {
  active_global_spec_t spec;
  memset(&spec, 0, sizeof(spec));
  spec.common.active_type = ACTIVE_ABSVAL;
...
int64_t tpu::AbsOp::getBufferSize_bm1684x(int64_t in_lmem_bytes,
...
void tpu::AbsOp::codegen_local_bm1684x(int64_t n_step, int64_t h_step) {
  int64_t n, c, h, w;
