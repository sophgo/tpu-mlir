...
LogicalResult tpu::Space2BatchOp::init(InferenceParameter &p) {
  return success();
}
void tpu::Space2BatchOp::deinit(InferenceParameter &p) {}

LogicalResult tpu::Space2BatchOp::inference(InferenceParameter &p) {
...
bool tpu::Space2BatchOp::support_multi_core() { return false; }
