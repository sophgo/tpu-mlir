...
LogicalResult tpu::ShapeScatterElementsOp::init(InferenceParameter &p) {
  return success();
}
void tpu::ShapeScatterElementsOp::deinit(InferenceParameter &p) {}

LogicalResult tpu::ShapeScatterElementsOp::inference(InferenceParameter &p) {
...
bool tpu::ShapeScatterElementsOp::support_multi_core() { return false; }
