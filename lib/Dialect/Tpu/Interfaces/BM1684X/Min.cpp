...
int64_t tpu::MinOp::getBufferSize_bm1684x(
...
void tpu::MinOp::codegen_local_bm1684x(int64_t n_step, int64_t c_step,
...
int64_t tpu::MinOp::get_fw_type_bm1684x() { return FW_BMNET_BROADCAST_BINARY; }
