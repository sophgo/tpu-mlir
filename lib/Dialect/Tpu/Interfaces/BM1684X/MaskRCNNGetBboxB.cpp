...
int64_t tpu::MaskRCNNGetBboxBOp::dyn_codegen_global_bm1684x(void *buffer) {
        ...
        MaskRCNN_get_bbox_B_global_param_t param = {0};
         ...
         param.global_buffer_13_glb_buffer_boxes =     module::getAddress(getGlbBufferBoxes());
         param.global_buffer_14_glb_buffer_scores =    module::getAddress(getGlbBufferScores());
         param.global_buffer_15_glb_buffer_nms =       module::getAddress(getGlbBufferNms());
         param.global_buffer_16_glb_buffer_nonzero =   module::getAddress(getGlbBufferNonzero());
         param.global_buffer_17_result_valid_ind =     module::getAddress(getResultValidInd());
         param.global_buffer_18_glb_lables =           module::getAddress(getGlbLables());
         param.global_buffer_19_glb_lables_expand =    module::getAddress(getGlbLablesExpand());
