...
void tpu::MaxPoolingIndicesBwdOp::codegen_global_bm1684x(){
    ...
    BM168x::call_global_func("backend_api_maxpooling_indices_bwd_global", &spec, sizeof(spec), input_spec->data(), output_spec->data());
}
...
// ======================================
uint32_t tpu::MaxPoolingIndicesBwdOp::dyn_codegen_global_bm1684(void *buffer) {return -1;}

int64_t tpu::MaxPoolingIndicesBwdOp::get_fw_type_bm1684() { return 0; }

int64_t tpu::MaxPoolingIndicesBwdOp::dyn_codegen_global_bm1684x(void *buffer) {return -1;}
