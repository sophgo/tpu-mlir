...
int64_t tpu::MaskRCNNMaskPoolerOp::dyn_codegen_global_bm1684x(void *buffer) {
        ...
        MaskRCNN_mask_pooler_global_param_t param = {0};
         ...
         param.global_buffer_1_result_filled_det_bboxes =   module::getAddress(getResultFilledDetBboxes());
         param.global_buffer_2_result_filled_det_labels =   module::getAddress(getResultFilledDetLabels());
