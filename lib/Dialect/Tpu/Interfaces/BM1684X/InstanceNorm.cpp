...
// ======================================
int64_t tpu::InstanceNormOp::dyn_codegen_global_bm1684x(void *buffer) { return 0; }

// ======================================
// Dynamic LocalGenInterface
// ======================================
int64_t tpu::InstanceNormOp::dyn_codegen_local_bm1684x(void *buffer) { return 0; }

int64_t tpu::InstanceNormOp::get_layer_type() {
