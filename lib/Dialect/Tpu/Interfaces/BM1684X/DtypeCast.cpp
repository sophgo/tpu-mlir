...
// int8
void tpu::DtypeCastOp::codegen_global_bm1684x() {
...
//     int64_t out_dslice, int64_t out_wslice, group_type_t group_type, bool
//     with_hw_margins) {
...
// void
// tpu::DtypeCastOp::codegen_local_bm1684x_kernel(std::vector<group_info_t>
// &in_group_infos,
//                                                       std::vector<group_info_t>
//                                                       &out_group_infos,
//                                                       local_sec_info_t
//                                                       &sec_info,
...
// dynamic codegen
// int64_t tpu::DtypeCastOp::dyn_codegen_local_bm1684x(void *buffer) {
//   bool qInput = module::isUniformQuantized(getInput());
//   bool qOutput = module::isUniformQuantized(getOutput());
//   auto in_type = module::getStorageType(getInput());
//   auto out_type = module::getStorageType(getOutput());
...
// ======================================
int64_t tpu::DtypeCastOp::dyn_codegen_global_bm1684x(void *buffer) {
  bool qInput = module::isUniformQuantized(getInput());
  bool qOutput = module::isUniformQuantized(getOutput());
  auto in_type = module::getStorageType(getInput());
  auto out_type = module::getStorageType(getOutput());
...
int64_t tpu::DtypeCastOp::get_fw_type_bm1684x() {
  bool qInput = module::isUniformQuantized(getInput());
  bool qOutput = module::isUniformQuantized(getOutput());
  auto in_type = module::getStorageType(getInput());
  auto out_type = module::getStorageType(getOutput());
