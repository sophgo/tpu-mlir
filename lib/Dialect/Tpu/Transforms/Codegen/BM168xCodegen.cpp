...
void BMCodegen::codegen(FuncOp funcOp) {
  ...
  funcOp.walk<WalkOrder::PreOrder>([&](Operation *op) {
    ...
    if (auto Conv2dOp = dyn_cast<tpu::Conv2DOp>(op)) {
      ...
      if (!(module::isBM1688() && !(BM168x::getDataType(Conv2dOp.getInput()) == DTYPE_FP32 && module::getShape(Conv2dOp.getInput())[0] <= 2))) {
      ...
      if (module::isBM1688() && in_shape.size() == 4 && in_shape[3] == 3 && in_shape[2] == 224
       || (!(module::isBM1688() && !(BM168x::getDataType(PermuteOp.getInput()) == DTYPE_FP32 && in_shape[0] <= 2)))) {
