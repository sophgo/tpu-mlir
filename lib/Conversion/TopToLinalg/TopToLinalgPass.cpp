...
struct ConvertTopToLinalg
    : public ::impl::ConvertTopToLinalgBase<ConvertTopToLinalg> {
public:
  void runOnOperation() override {
    ...
    populateTopToLinalgConversionPatterns(&patterns);
...
std::unique_ptr<Pass> createConvertTopToLinalg() {
  return std::make_unique<ConvertTopToLinalg>();
}
