...
void IndexPutLowering::LoweringINT8(PatternRewriter &rewriter,
                                    top::IndexPutOp op, bool asymmetric) const {
...
void IndexPutLowering::LoweringINT4(PatternRewriter &rewriter,
                                    top::IndexPutOp op, bool asymmetric) const {
