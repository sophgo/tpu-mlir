...
void UnsqueezeTryLowering::Lowering(PatternRewriter &rewriter,
  ...
  rewriter.replaceOpWithNewOp<tpu::ShapeUnsqueezeOp>(op, new_type, op.getOperand(), attrs);
}
...
void UnsqueezeLowering::LoweringINT4(PatternRewriter &rewriter, top::UnsqueezeOp op,
                                   bool asymmetric) const {
  LoweringINT8(rewriter, op, asymmetric);
}
void UnsqueezeLowering::LoweringINT8(PatternRewriter &rewriter,
                                    top::UnsqueezeOp op, bool asymmetric) const {
