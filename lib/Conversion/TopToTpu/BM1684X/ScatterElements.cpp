...
void ScatterElementsTryLowering::Lowering(PatternRewriter &rewriter,
  ...
  rewriter.replaceOpWithNewOp<tpu::ShapeScatterElementsOp>(
      op, new_type, op.getOperands(), attrs);
}
