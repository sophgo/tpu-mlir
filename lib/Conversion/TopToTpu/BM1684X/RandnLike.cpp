...
void RandnLikeLowering::LoweringINT4(PatternRewriter &rewriter, top::RandnLikeOp op,
                                 bool asymmetric) const {
  UNREACHABLE_OP("Not Implemented", op);
}
void RandnLikeLowering::LoweringINT8(PatternRewriter &rewriter, top::RandnLikeOp op,
                                 bool asymmetric) const {
