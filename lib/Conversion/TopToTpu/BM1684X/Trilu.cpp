...
void TriluLowering::LoweringF32(PatternRewriter &rewriter, top::TriluOp op) const {
...
void TriluLowering::LoweringF8(PatternRewriter &rewriter, top::TriluOp op) const {
