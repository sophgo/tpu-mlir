...
void SwapChannelLowering::LoweringINT8(PatternRewriter &rewriter, top::SwapChannelOp op,
                                   bool asymmetric) const {
  lowering_common_int8<tpu::SwapChannelOp>(rewriter, op, asymmetric);
}
void SwapChannelLowering::LoweringINT4(PatternRewriter &rewriter, top::SwapChannelOp op,
                                   bool asymmetric) const {
