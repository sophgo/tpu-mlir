...
void BM1690E::before_codegen() {
  BM1684X::before_codegen();
  useCode0 = true;
}

void BM1690E::after_codegen(int64_t flops) {
...
void BM1690E::setCoreNum(int core) {
...
void BM1690E::useCore(int coreID) {
