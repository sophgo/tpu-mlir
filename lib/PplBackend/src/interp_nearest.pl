...
__KERNEL__ void interp_nearest_bf16(bf16 *ptr_output, bf16 *ptr_input, const int g_core_num, const int N, const int C, const int H_in, const int W_in, const int H_out, const int W_out, const int block_h, const int block_w, const int align_corners) {
            interp_<bf16>(ptr_output, ptr_input,  g_core_num, N,  C,  H_in,  W_in,  H_out,  W_out,  block_h, block_w, align_corners);
}
__KERNEL__ void interp_nearest_fp16(fp16 *ptr_output, fp16 *ptr_input,  const int g_core_num, const int N, const int C, const int H_in, const int W_in, const int H_out, const int W_out, const int block_h, const int block_w, const int align_corners) {
            interp_<fp16>(ptr_output, ptr_input,  g_core_num, N,  C,  H_in,  W_in,  H_out,  W_out,  block_h, block_w, align_corners);
}
__KERNEL__ void interp_nearest_fp32(fp32 *ptr_output, fp32 *ptr_input, const int g_core_num, const int N, const int C, const int H_in, const int W_in, const int H_out, const int W_out, const int block_h, const int block_w, const int align_corners) {
