...
export INPUT=data
#export OUTPUTS=prob
export TOLERANCE_INT8=0.95,0.70  # 0.97,0.76
export TOLERANCE_BF16=0.998,0.990
export TOLERANCE_BF16_CMDBUF=0.99,0.99,0.96
export EXCEPTS=prob
export MODEL_CHANNEL_ORDER="bgr"
...
#export OUTPUTS=prob
export EXCEPTS=data
export TOLERANCE_INT8=0.96,0.73  # 0.91,0.56
...
export INPUT_SCALE=0.00392,0.00392,0.00392
export EXCEPTS=output
export TOLERANCE_INT8=0.98,80  # 0.93,0.54
export TOLERANCE_BF16=0.99,0.96
export TOLERANCE_BF16_CMDBUF=0.99,0.96
export YOLO_V3=1
export TINY=1
...
export TOLERANCE_INT8=0.88,0.49  # 0.78,0.19
export CALI_IMAGES=$DATA_SET/coco/val2017
fi
