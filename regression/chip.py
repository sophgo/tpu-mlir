...
full_model_list = {
    ...
    "blazeface":                  (N,      Y,       N,      Y,      N,      Y,      Y,      N),
    "densenet121-12":             (N,      Y,       Y,      Y,      N,      Y,      Y,      Y),
    "densenet201":                (N,      N,       N,      N,      N,      Y,      Y,      N),
    "ecanet50":                   (N,      Y,       N,      N,      N,      N,      Y,      N),
    "efficientdet-d0":            (N,      N,       N,      Y,      N,      Y,      Y,      N),
    "efficientnet":               (N,      Y,       Y,      N,      N,      Y,      Y,      Y),
    "inception_v3":               (N,      Y,       Y,      N,      N,      Y,      Y,      Y),
    "mnist-12":                   (N,      Y,       Y,      N,      N,      Y,      Y,      Y),
    "mobilenet_v2":               (N,      Y,       Y,      N,      N,      Y,      Y,      Y),
    "resnet18_v1":                (N,      Y,       Y,      Y,      N,      Y,      Y,      Y),
    ...
    "yolov8n":                    (N,      N,       N,      N,      N,      Y,      Y,      N),
    "nasnet_mobile":              (N,      N,       N,      Y,      N,      Y,      Y,      N),
    "espcn_3x":                   (N,      N,       N,      Y,      N,      Y,      Y,      N),
    ######## Pytorch #######      ######
    ...
    ######## caffe #########      #####
    "mobilenet_v2_cf":            (N,      Y,       Y,      Y,      N,      Y,      Y,      Y),
    ...
    "googlenet_cf":               (N,      Y,       N,      Y,      N,      Y,      Y,      N),
    "icnet_cf":                   (N,      N,       N,      N,      N,      N,      Y,      N),
    "inception_v4_cf":            (N,      Y,       N,      N,      N,      N,      Y,      N),
    "ssd300_cf":                  (N,      N,       N,      N,      N,      N,      Y,      N),
    "yolov3_spp_cf":              (N,      N,       N,      N,      N,      N,      Y,      N),
    "yolov4_cf":                  (N,      N,       N,      N,      N,      N,      Y,      N),
    "resnext50_cf":               (N,      N,       N,      N,      N,      Y,      Y,      N),
    "mobilenetv2_ssd_cf":         (N,      N,       N,      N,      N,      Y,      Y,      N),
    # ----- cvs20-test -----      -------
    "feature_extract_cf":         (N,      Y,       Y,      N,      N,      Y,      Y,      Y),
    "squeezenet_v1.1_cf_cvs20":   (N,      Y,       Y,      N,      N,      Y,      Y,      Y),
    "squeezenet_v1.1_cf":         (N,      Y,       Y,      Y,      N,      Y,      Y,      Y),
    ######## tflite ########      ########
