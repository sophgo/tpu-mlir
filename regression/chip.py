...
full_model_list = {
    ...
    "blazeface":                  (N,      N,       N,      N,      N,      N,      Y,      N),
    "densenet121-12":             (N,      Y,       Y,      N,      N,      Y,      Y,      Y),
    "densenet201":                (N,      N,       N,      N,      N,      N,      Y,      N),
    "ecanet50":                   (N,      N,       N,      N,      N,      N,      Y,      N),
    "efficientdet-d0":            (N,      N,       N,      N,      N,      N,      Y,      N),
    ...
    "googlenet_cf":               (N,      N,       N,      N,      N,      N,      Y,      N),
    "icnet_cf":                   (N,      N,       N,      N,      N,      N,      Y,      N),
    "inception_v4_cf":            (N,      N,       N,      N,      N,      N,      Y,      N),
