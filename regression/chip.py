...
basic_model_list = {
    ...
    "mobilenet_v2_cf":            (N,      Y,       Y,      Y,      N,      Y,      Y,     N,      N,       N,       N),
    "resnet50_v2":                (Y,      N,       N,      N,      N,      Y,      Y,     N,      Y,       Y,       Y),
    "yolov5s":                    (N,      Y,       Y,      N,      N,      Y,      Y,     Y,      Y,       N,       Y),
    "yolov5s_pt":                 (N,      Y,       N,      N,      N,      N,      N,     N,      N,       N,       N),
    ...
    "swint_block":                (N,      Y,       Y,      N,      N,      N,      N,     N,      N,       N,       N),
    "sam_block":                  (N,      Y,       N,      N,      N,      N,      N,     N,      N,       N,       N),
    "cswin_block":                (N,      Y,       N,      N,      N,      N,      N,     N,      N,       N,       N),
}
...
full_model_list = {
    ...
    "densenet201":                (N,      N,       N,      N,      N,      Y,      Y,      N,     N,     N,       N),
    "ecanet50":                   (N,      Y,       N,      N,      N,      N,      Y,      N,     N,     N,       N),
    "efficientdet-d0":            (N,      N,       N,      Y,      N,      Y,      Y,      N,     N,     N,       N),
    "efficientnet":               (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N),
    "efficientnetv2":             (N,      N,       N,      N,      N,      N,      N,      N,     N,     N,       N),
    "inception_v3":               (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N), # bm1690 f16, bf16 has problem
    "mnist-12":                   (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     Y,     N,       N),
    "mobilenet_v2":               (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     Y,     N,       Y),
    "resnet18_v1":                (N,      Y,       Y,      Y,      N,      Y,      Y,      Y,     Y,     N,       N),
    "resnet18_v2":                (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N),
    "resnet50_v1":                (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N),
    "resnet50_v2":                (Y,      Y,       Y,      N,      N,      Y,      Y,      Y,     Y,     N,       N),
    "res2net50":                  (N,      Y,       N,      N,      N,      N,      Y,      N,     N,     N,       N),
    "retinaface":                 (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N),
    "se-resnet50":                (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N),
    "shufflenet_v2":              (N,      Y,       Y,      Y,      N,      Y,      Y,      Y,     N,     N,       N),
    "squeezenet1.0":              (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     Y,     N,       N),
    "ssd-12":                     (N,      Y,       Y,      N,      N,      N,      N,      Y,     Y,     N,       N),
    "swin_transformer":           (Y,      Y,       Y,      N,      N,      N,      N,      Y,     N,     N,       N),
    "ultraface_640":              (N,      Y,       Y,      N,      N,      N,      N,      Y,     N,     N,       N),
    "unet":                       (N,      N,       N,      N,      N,      N,      Y,      N,     N,     N,       N),
    "unet_plusplus":              (N,      N,       N,      N,      N,      N,      N,      N,     N,     N,       N),
    "vgg16":                      (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     Y,     N,       N),
    "yolov5s":                    (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N),
    "yolov3":                     (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N),
    "yolov3_tiny":                (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     Y,     N,       N),
    "yolov4s":                    (N,      Y,       N,      N,      N,      Y,      Y,      N,     N,     N,       N),
    ...
    "arcface_res50":              (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N),
    ...
    "inception_v4_cf":            (N,      Y,       N,      N,      N,      N,      Y,      N,     N,     N,       N),
    ...
    "squeezenet_v1.1_cf_cvs20":   (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     Y,     N,       N),
    ...
    "pp_ocr_cls":                 (N,      Y,       Y,      N,      N,      Y,      Y,      Y,     N,     N,       N),
    "pp_ocr_rec":                 (N,      Y,       N,      N,      N,      N,      N,      N,     N,     N,       N), # bf16 bm1688, cv186x has problem
