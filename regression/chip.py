...
basic_model_list = {
    ...
    "yolov5s_tf":                 (N,      Y,       Y,      N,      N,      N,      N,     N,      N,       N,       N,    N),
...
full_model_list = {
    ...
    ######## tflite ########      ########
    "inception_v4_tf":            (N,      Y,       Y,      N,      N,      N,      N,      Y,     N,     N,       N,     N),
    "mobilenet_v2_tf":            (N,      Y,       Y,      N,      N,      N,      N,      Y,     N,     N,       N,     N),
    "resnet50_tf":                (N,      Y,       Y,      N,      N,      N,      N,      Y,     N,     N,       N,     N),
    "ssd_mobilenet_v1_tf":        (N,      Y,       Y,      N,      N,      N,      N,      Y,     N,     N,       N,     N),
    "yolov5s_tf":                 (N,      Y,       Y,      N,      N,      N,      N,      Y,     N,     N,       N,     N),
    "mobilebert_tf":              (N,      Y,       Y,      N,      N,      N,      N,      Y,     N,     N,       N,     N),
    ######## PaddlePaddle ##      ##############
