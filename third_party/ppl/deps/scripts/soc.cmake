...
# Set the C compiler
if(${CHIP} STREQUAL "tpu_6_0" OR ${CHIP} STREQUAL "tpub_7_1")
...
link_directories(${BACKEND_SOC_LIB_PATH} ${BACKEND_LIB_PATH} ${RUNTIME_TOP}/lib)

# Set the library directories for the shared library (link libfirmware_core.a)
set(SHARED_LIBRARY_OUTPUT_FILE libkernel)
aux_source_directory(device DEVICE_SRCS)
set(LIBBMCHIP_PATH "${BACKEND_LIB_PATH}/libfirmware_core.a")
...
set(INPUT_FILE "${CMAKE_BINARY_DIR}/libkernel.so")
...
foreach(app_src IN LISTS APP_SRC_FILES)
  ...
  add_executable(${app} ${app_src} ${CUS_TOP}/host/src/cnpy.cpp)
  target_link_libraries(${app} PRIVATE host ${RUNTIME_LIBS} libtpudnn.a dl pthread ${ZLIB_LIB})
