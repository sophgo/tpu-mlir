...
if(NOT DEFINED ENV{TPUC_ROOT})
  ...
  elseif(${CHIP} STREQUAL "tpu_6_0")
    set(BMLIB_CMODEL_PATH $ENV{TPUC_ROOT}/lib/libbackend_bm1684x.so)
  elseif(${CHIP} STREQUAL "tpu_6_0_e")
    set(BMLIB_CMODEL_PATH $ENV{TPUC_ROOT}/lib/libbackend_bm1684xe.so)
  elseif(${CHIP} STREQUAL "tpul_6_0")
    set(BMLIB_CMODEL_PATH $ENV{TPUC_ROOT}/lib/libbackend_bm1688.so)
  elseif(${CHIP} STREQUAL "tpul_8_1")
    set(BMLIB_CMODEL_PATH $ENV{TPUC_ROOT}/lib/libbackend_cv184x.so)
  elseif(${CHIP} STREQUAL "tpub_9_3")
    set(BMLIB_CMODEL_PATH $ENV{TPUC_ROOT}/lib/libbackend_bm1684x2.so)
  elseif(${CHIP} STREQUAL "tpub_7_1_e")
    set(BMLIB_CMODEL_PATH $ENV{TPUC_ROOT}/lib/libbackend_bm1690e.so)
  else()
