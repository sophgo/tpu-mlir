...
if(NOT DEFINED ENV{CROSS_TOOLCHAINS})
  ...
  execute_process(
    COMMAND bash -c "CHIP=${CHIP} DEV_MODE=pcie source $ENV{PPL_PROJECT_ROOT}/deps/scripts/download_toolchain.sh && env"
...
set_target_properties(${SHARED_LIBRARY_OUTPUT_FILE} PROPERTIES OUTPUT_NAME ${OUT_NAME})
...
#   LINK_FLAGS "-shared"
# )
target_compile_options(${SHARED_LIBRARY_OUTPUT_FILE} PRIVATE -fPIC ${FW_DEBUG_FLAGS})
