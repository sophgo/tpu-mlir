...
tpudnnStatus_t tpudnnCumsumLastDimAsync(
    tpudnnHandle_t handle,
    tpudnnTensor_t input,
    tpudnnTensor_t inner_mask,
    tpudnnTensor_t inter_mask,
    tpudnnTensor_t inter_core_mask,
    tpudnnTensor_t output);
...
tpudnnStatus_t tpudnnC2CReduceScatter(
    tpudnnHandle_t      handle,
    void *              send_buff,
    void *              recv_buff,
    uint64_t            recv_count,
...
tpudnnStatus_t tpudnnLatentAttentionFp8Async(
    tpudnnHandle_t handle,
    tpudnnTensor_t OUT,
    tpudnnTensor_t Q,
    tpudnnTensor_t KV,
...
tpudnnStatus_t tpudnnLLamaMlpAsync (
    ...
    tpudnnTensor_t bias0,
    tpudnnTensor_t bias1,
    tpudnnTensor_t bias2,
    tpudnnTensor_t fc1,
    tpudnnTensor_t m0,
    tpudnnTensor_t output,
    bool save_mid_res);

tpudnnStatus_t tpudnnMlpbackward(tpudnnHandle_t handle,
    tpudnnTensor_t input,
    tpudnnTensor_t weight0,
    tpudnnTensor_t weight1,
    tpudnnTensor_t weight2,
...
tpudnnStatus_t tpudnnFusedTopkIndicesAsync(
    tpudnnHandle_t handle,
    tpudnnTensor_t topk_indices,
    tpudnnTensor_t q,
    tpudnnTensor_t k,
    tpudnnTensor_t w,
    tpudnnTensor_t k_cache,
    tpudnnTensor_t input_length_tensor,
    tpudnnTensor_t cache_length_tensor,
