...
void rvt_fmm2_bq_fp8(TCR out, TCR x, TCR w, TCR xs, TCR ws,
                     const uint32_t _gsize, const uint32_t _w_block);
void rvt_fmm2a_bq_fp8(TCR out, TCR x, TCR w, TCR xs, TCR ws,
                      const uint32_t _gsize, const uint32_t _w_block);
void rvt_fmm2_bq_fp4(TCR out, TCR x, TCR w, TCR xs, TCR ws, TCR os,
                     const uint32_t _gsize);
void rvt_fmm2a_bq_fp4(TCR out, TCR x, TCR w, TCR xs, TCR ws, TCR os,
                      const uint32_t _gsize);
