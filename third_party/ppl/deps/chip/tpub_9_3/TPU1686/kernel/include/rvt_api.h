...
#define POW2_BF16_LBIT_TAYLOR_OFFSET (POW2_FP16_LBIT_TAYLOR_OFFSET  + POW2_LBIT_TAYLOR_SIZE * sizeof(float)) // for eu align
#define POW2_HBIT_LUT_OFFSET        (POW2_BF16_LBIT_TAYLOR_OFFSET  + POW2_LBIT_TAYLOR_SIZE * sizeof(float)) // for eu align
...
static TCR rvt_cr(int ca, int prec, bool sign, uint64_t *val) {
  ...
  if (rand() % 2) {
    ...
    uint32_t itype = (prec == 0 || prec == 3 || prec == 4 || prec == 6) ? TYPE_INTEGAL : TYPE_FLOAT;
    rvt_cfgcr32(ca,  __SR((uint64_t)teew << 59 | (*val & 0xffffffffffffff)), itype, teew>>1, sign);
  }
  return ca;
}

static TCR rvt_tr(int ta, int prec, bool sign, uint32_t offset,
...
static TCR rvt_gr(int ga, int prec, bool sign, uint64_t addr,
        LAYOUT_E layout, array4_t shape, int *strides) {
  uint16_t teew = __prec_to_teew(prec, sign);
...
void rvt_conv(TCR out, TCR x, TCR w, TCR bias, TCR rq);
void rvt_conva(TCR out, TCR x, TCR w, TCR bias, TCR rq);
...
void rvt_mm2_nn(TCR out, TCR x, TCR w, TCR bias, TCR rq, const uint32_t _relu);
void rvt_mm2_nt(TCR out, TCR x, TCR w, TCR bias, TCR rq, const uint32_t _relu);
void rvt_mm2_tt(TCR out, TCR x, TCR w, TCR bias, TCR rq, const uint32_t _relu);
void rvt_mm2a_nn(TCR out, TCR x, TCR w, TCR bias, TCR rq, const uint32_t _relu);
void rvt_mm2a_nt(TCR out, TCR x, TCR w, TCR bias, TCR rq, const uint32_t _relu);
void rvt_mm2a_tt(TCR out, TCR x, TCR w, TCR bias, TCR rq, const uint32_t _relu);
...
void rvt_fmm2_bq_fp8(TCR out, TCR x, TCR w, TCR xs, TCR ws, const uint32_t _gsize, const uint32_t _w_block);
void rvt_fmm2a_bq_fp8(TCR out, TCR x, TCR w, TCR xs, TCR ws, const uint32_t _gsize, const uint32_t _w_block);
void rvt_fmm2_bq_fp4(TCR out, TCR x, TCR w, TCR xs, TCR ws, TCR os, const uint32_t _gsize);
void rvt_fmm2a_bq_fp4(TCR out, TCR x, TCR w, TCR xs, TCR ws, TCR os, const uint32_t _gsize);
...
void rvt_dma_red(TCR gd, TCR src, TCR scale, const uint32_t _rw, const uint32_t _op);
void rvt_dma_fred(TCR gd, TCR src, TCR scale, const uint32_t _rw, const uint32_t _op);
