...
if(${CHIP} STREQUAL "bm1690")
  ...
  target_link_libraries(main PRIVATE tpuv7_rt cdm_daemon_emulator pthread ${ZLIB_LIBRARIES})
elseif(${CHIP} STREQUAL "bm1684x" OR ${CHIP} STREQUAL "bm1688")
  add_executable(main ${APP_SRC_FILES}
                      ${HOST_SRC_FILES}
                      ${CUS_TOP}/src/cnpy.cpp
                      ${CUS_TOP}/src/host_utils.cpp)
  target_link_libraries(main PRIVATE ${RUNTIME_TOP}/lib/libbmlib.so pthread ${ZLIB_LIBRARIES})
endif()
