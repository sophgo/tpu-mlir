...
link_directories(${PPL_TOP}/runtime/${CHIP}_soc/lib)
...
set(TPUDNN_LIB "${PPL_TOP}/runtime/${CHIP}_soc/lib/libtpudnn.a")
...
foreach(app_src IN LISTS APP_SRC_FILES)
  ...
  elseif(${CHIP} STREQUAL "bm1684x" OR ${CHIP} STREQUAL "bm1688")
    target_link_libraries(${app} PRIVATE host ${BM_LIBS} ${TPUDNN_LIB} pthread ${ZLIB_LIB})
  endif()
