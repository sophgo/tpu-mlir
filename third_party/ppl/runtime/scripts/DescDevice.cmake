...
if(DEFINED RUNTIME_PATH)
  ...
  if(${CHIP} STREQUAL "bm1690")
    set(RUNTIME_TOP ${PPL_TOP}/runtime/bm1690/)
    if(NOT DEFINED ENV{TPUC_ROOT})
      set(BMLIB_CMODEL_PATH ${RUNTIME_TOP}/lib/libtpuv7_emulator.so)
    else()
      set(BMLIB_CMODEL_PATH $ENV{TPUC_ROOT}/lib/libtpuv7_emulator.so)
    endif()
  elseif(${CHIP} STREQUAL "sg2262")
    set(RUNTIME_TOP ${PPL_TOP}/runtime/sg2262)
    if(NOT DEFINED ENV{TPUC_ROOT})
      set(BMLIB_CMODEL_PATH ${RUNTIME_TOP}/lib/libtpuv7_emulator.so)
    else()
      set(BMLIB_CMODEL_PATH $ENV{TPUC_ROOT}/lib/libtpuv7_emulator.so)
...
if(${CHIP} STREQUAL "bm1684x" OR ${CHIP} STREQUAL "bm1688" OR ${CHIP} STREQUAL "bm1684xe")
