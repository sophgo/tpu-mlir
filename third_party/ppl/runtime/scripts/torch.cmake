...
target_link_libraries(tpu_kernel PRIVATE ${FIRMWARE_CORE} m)
...
if(DEFINED ENV{TORCH_TPU_RUNTIME_PATH})
  ...
  set(CMODEL_PATH $ENV{TORCH_TPU_RUNTIME_PATH})
  set_target_properties(tpu_kernel PROPERTIES INSTALL_RPATH "${CMODEL_PATH}")
else()
  set_target_properties(tpu_kernel PROPERTIES INSTALL_RPATH "${CMODEL_PATH}")
endif()
