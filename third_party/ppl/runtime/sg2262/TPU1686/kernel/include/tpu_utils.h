...
static inline data_type_t tpu_type_convert(sg_data_type_t data_type) {
    ...
    case SG_DTYPE_FP8E4M3: dtype = DT_FP8E4M3; break;
    case SG_DTYPE_FP8E5M2: dtype = DT_FP8E5M2; break;
    case SG_DTYPE_FP20:    dtype = DT_FP20;    break;
    case SG_DTYPE_TF32:    dtype = DT_TF32;    break;
    default:
        TPUKERNEL_ASSERT(0);
        break;
    }
