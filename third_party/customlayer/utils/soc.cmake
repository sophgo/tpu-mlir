if ("$ENV{CUSTOM_LAYER_CHIP_ARCH}" STREQUAL "bm1684x")
  ...
  target_link_libraries(${KM_CUSTOM_1684X_SOC_OUTPUT_FILE} -Wl,--whole-archive $ENV{INSTALL_PATH}/lib/libbm1684x_kernel_module.a -Wl,--no-whole-archive m)
...
elseif ("$ENV{CUSTOM_LAYER_CHIP_ARCH}" STREQUAL "bm1688")
  ...
  target_link_libraries(${KM_CUSTOM_1688_SOC_OUTPUT_FILE} -Wl,--whole-archive $ENV{INSTALL_PATH}/lib/libbmtpulv60_kernel_module.a -Wl,--no-whole-archive m)
