if ("$ENV{CUSTOM_LAYER_CHIP_ARCH}" STREQUAL "bm1684x")
  ...
  target_link_libraries(${CMODEL_CUSTOM_1684X_OUTPUT_FILE} -Wl,--whole-archive $ENV{TPUC_ROOT}/lib/libcmodel_bm1684x.so -Wl,--no-whole-archive m)
...
elseif ("$ENV{CUSTOM_LAYER_CHIP_ARCH}" STREQUAL "bm1688")
  ...
  target_link_libraries(${CMODEL_CUSTOM_1688_OUTPUT_FILE} -Wl,--whole-archive $ENV{TPUC_ROOT}/lib/libcmodel_bm1688.so -Wl,--no-whole-archive m)
