...
// CHECK-NEXT: %[[VAR0:.*]] = "tpu.Cast"(%arg0) {name = ""} : (tensor<?x3x224x224xf32>) -> tensor<?x3x224x224x!quant.uniform<i8:f32, 1.0774157047271729:-13>>
...
// CHECK-NEXT: %[[VAR0:.*]] = "tpu.Cast"(%arg0)
// CHECK-NEXT: %[[VAR1:.*]] = "tpu.Softmax"(%[[VAR0]])
// CHECK-NEXT: %[[VAR2:.*]] = "tpu.Cast"(%[[VAR1]])
...
// CHECK-LABEL: @test_simplify_cast
// CHECK-NEXT:  return %arg0 : tensor<4x1000xf32>
func.func @test_simplify_cast(%arg0 : tensor<4x1000xf32>) -> tensor<4x1000xf32> {
    %0 = "tpu.Cast"(%arg0) {name = ""} : (tensor<4x1000xf32>) -> tensor<4x1000x!quant.uniform<i8:f32, 3.906250e-03:-128>>
    %1 = "tpu.Cast"(%0) {name = ""} : (tensor<4x1000x!quant.uniform<i8:f32, 3.906250e-03:-128>>) -> tensor<4x1000xf32>
