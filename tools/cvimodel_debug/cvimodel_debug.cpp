...
static void usage() {
  ...
  std::cout << "Parameter1: xxx.cvimodel \n";
  std::cout << "Parameter2: xxx_tensor_info.txt, generated by codegen pass.\n";
  std::cout << "Parameter3: input.npz.\n";
  std::cout << "Parameter4: output.npz.\n";
  std::cout << "Parameter5: ref.npz, compared with the debug output.npz.\n";
  std::cout << "Parameter6: tolerance, default as 0.98,0.95 \n";
