...
// void ConvertFp32ToUint8(float *src, uint8_t dst, int count, float qscale, int zero_point = 0);
// void ConvertFp32ToInt16(float *src, int16_t *dst, int count);
// void ConvertFp32ToUInt16(float *src, uint16_t *dst, int count);
// void ConvertFp32ToBf16(float *src, uint16_t *dst, int size, bool rounding);
}
