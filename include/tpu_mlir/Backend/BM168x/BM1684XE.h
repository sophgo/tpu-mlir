...
namespace tpu_mlir {
namespace backend {
class BM1684XE : public BM168x {
public:
  static BM1684XE &instance() {
    static BM1684XE bm1684xe;
    return bm1684xe;
  }
...
public:
  ...
  static constexpr llvm::StringRef LIB_KERNEL_NAME =
      "libbm1684xe_kernel_module.so";

protected:
  BM1684XE() : BM168x(TypeID::get<BM1684XE>()) {
    if (chip != module::Chip::BM1684XE) {
      return;
    }
    ...
    LIB_BACKEND_NAME = "libbackend_1684xe.so";
