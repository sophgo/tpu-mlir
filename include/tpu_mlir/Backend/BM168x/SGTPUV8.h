...
public:
  ...
  static SGTPUV8 &instance(int frequency) {
    static SGTPUV8 SGTPUV8;
    // SGTPUV8.set_simulation_freq(frequency);
    return SGTPUV8;
  }
...
protected:
  SGTPUV8() {
    ...
    LIB_BACKEND_NAME = "libbackend_sgtpuv8.so";
    // GDMA format
