...
#define CVI_TPU_VERSION_MARS  "mars"
#define CVI_TPU_VERSION_PHOBOS "phobos"
...
protected:
  // static constexpr llvm::StringRef LIB_NAME = "libcvikernel.so";
  const llvm::StringRef LIB_NAME = "libcvikernel.so";
